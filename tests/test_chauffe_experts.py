"""La chauffe du contexte sollicite les experts comme une vraie requête (Sage sage-s2-k48-feu-vert-21-09 § 2 (d)).
...
def test_une_chauffe_aleatoire_sollicite_plus_d_experts_que_des_uns(tiny_moe):
    """Sage sage-s2-k48-feu-vert-21-09 § 2 (d) : ``[1]×N`` route tous les jetons vers les mêmes top_k experts par
