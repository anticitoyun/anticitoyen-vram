"""Échelle AWQ PAR EXPERT dans la pile (Sage, revue/sage-glm-awq-pile-15-09.md) :
...
def test_table_unite_sautee(monkeypatch):
    """Échelle absente écrite comme identité explicite (Manon 2205709) : la
    table vaut 1 partout, le produit est sauté (Sage § 8 : coût 0 sur un modèle
...
def test_compte_de_lancements_avec_awq(egales):
    """Sage (sage-glm-gateup-16-09) : lever gate ≠ up = une seconde
    nvfp4_quant_act, rien d'autre. Égales : 8 lancements/couche comme sans AWQ
    (la division AWQ vit dans nvfp4_quant_act, sage-glm-pile-correctif § 1.4) ; distinctes : 9."""
