"""Critère de décodage (Sage §7.2, revue/sage-reprise-15-09-b.md) : au
décodage, un nombre d'ulp fixe ne juge pas (5 ulp échoue 739/768 sur le
témoin lui-même, Laure f9fce44) — B/A doit dominer un témoin mesuré au
...
def test_verdict_narrow_reel_de_laure_passe():
...
def test_seuil_fixe_echoue_sur_son_propre_temoin():
    """Motif exact rapporté par Sage : 5 ulp / cos>=0,9999 échoue
