"""Q1 (Maîtresse 21/09, arXiv 2512.02010 « Four Over Six ») : échelle de bloc nvfp4 adaptative — par bloc de 16, deux
...
signes ; (6) sur carte : noyau nvfp4_dequant == référence au bit sur un tenseur 4sur6 (sauté sans carte, à jouer par Manon)."""
import pytest, torch
...
CARTE = pytest.mark.skipif(not torch.cuda.is_available(), reason="carte requise : noyau nvfp4_dequant (Manon)")
