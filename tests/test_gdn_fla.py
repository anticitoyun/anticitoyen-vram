...
une optimisation qui change la sortie est un bogue (poste7-priorite-apres-
campagne-17-09 § 2).
...
exigé par poste7 : l'état passé à fla avec l'axe [K, V] inversé doit rendre le
...
SEUIL = 2 ** -7                    # relatif, le critère de poste7 (bf16) ; ici tout est fp32
...
def test_un_moteur_charge_a_sec_ecrit_la_voie_gdn_dans_son_regime(converted, monkeypatch):
    """Le contrôle demandé par chef/poste7 : pas la lecture du code, la ligne
