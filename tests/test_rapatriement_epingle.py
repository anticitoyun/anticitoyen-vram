"""Levier 2 (revue/oceane-levier-2-conception-22-09 § 3) : rapatriement des
ids/logprobs par tampon hôte épinglé à double parité, DÉFAUT depuis le
verdict Laurine 22/09 ; témoin `ACVRAM_RAPATRIEMENT_FLUX=1`. Tests à sec (tenseurs CPU, faux graphes,
faux événement) ; carte : Manon. Ce qui doit casser : ids ou logprobs qui
...
def test_tampon_epingle_exactement_2_n_et_contigu():
    """Manon 22/09 (levier 2 réfuté à la frontière : suite_prep 151 → 6 860 µs) :
...
def test_defaut_epingle_et_temoin_flux(monkeypatch, capsys):
    """Défaut = épinglé (verdict Laurine 22/09) ; ACVRAM_RAPATRIEMENT_FLUX=1 =
