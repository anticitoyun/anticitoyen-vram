"""Ajout GUI n°3 (sage-gui-ajouts-18-09 § 3), corrigé le 18/09
(sage-metrics-energie-fenetre-18-09) : `AnneauEnergie` intègre le J/jeton
...
par Laure au contrôle GUI). Recette : à vide « — » (None), jamais 0."""
...
def test_jetons_fenetre_accompagne_toujours_j_par_jeton():
    """Sage (sage-metrics-energie-fenetre-18-09) : `jetons_fenetre()` = 0
