"""sage-awq-relu2-garde-repli-17-09 geste (d), CORRIGÉ par
sage-awq-plancher-median-faute-18-09 : plancher borné sur l'ÉTENDUE
...
def test_bras_casse_le_plancher_median_dhier_depasse_4096_a_90_pour_cent_de_canaux_nuls(monkeypatch):
    """Le bogue de `sage-awq-relu2-garde-repli-17-09` (982ad80), figé en
