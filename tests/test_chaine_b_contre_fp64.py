"""Chantier 1 (poste7 20/09 13 h 45, après T4) — TEST D'INSTRUMENT, pas un correctif : l'erreur
...
(la faute de poste7 est sous la résolution de ce juge, et on le dit) ; le test cherche le plus petit facteur
