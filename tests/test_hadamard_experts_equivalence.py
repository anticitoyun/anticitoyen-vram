"""Rotation Hadamard bloc-diagonale H_512 sur les poids d'experts (poste7,
revue/poste7-hadamard-16-09.md) : x·H·(W·H)ᵀ = x·Wᵀ, H orthogonale block-
...
divisibles par 512 — c'est précisément pourquoi poste7 a choisi ce bloc
