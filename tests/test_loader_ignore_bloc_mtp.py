...
comme une couche de décodage supplémentaire — Manon a trouvé que le
convertisseur écrivait ce bloc sous la même clé qu'une couche MoE
normale (revue/prediction-mtp-loader-15-09.md, Jérôme/Sage 15/09) ; ce
...
def _checkpoint_avec_bloc_fantome(tmp_path):
    ...
    convertisseur actuel de GLM-4.7-Flash avant le correctif de Manon
...
def test_le_manifeste_converti_ne_declare_pas_le_bloc_fantome(tmp_path, target_rig):
    ...
    # Le bogue de conversion (Manon, 15/09) est REPRODUIT ici : le
