...
mesure sur un moteur dégradé — bead runner 14/09, précisé le 15/09 (Sage,
revue/sage-glm-formats-mixtes-15-09.md §2) : `energie.py`/le duel
...
def test_piles_ok_false_nomme_la_cause_dans_le_message():
    """Sage 15/09 : pas "hétérogène" affirmé sans preuve — la cause
