"""Garde `refus_nvfp4_sans_gpu` (Maîtresse 21/09) : un nom de sortie ou `--format nvfp4` sans palier GPU dans le plan
est refusé (rc 2), le message nomme memory/tiering.py:360-366. Le 30B « -nvfp4-vision » du 20/09 avait été converti
sans carte : int4_awq planifié processeur sous un nom nvfp4 (`oceane-hypotheses-qvl-30b-21-09`)."""
