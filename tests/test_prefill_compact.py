...
def test_le_defaut_est_compact_sans_norm():
    """DÉFAUT 1 depuis le 20/09 (verdict-c15-prefill-19-09, Manon bcd7a73b : au bit 3 tranches, capture 4/4,
...
def test_la_ligne_de_regime_nomme_la_glue_du_prefill(monkeypatch):
    ...
    # « norm » hors défaut (3,82 ms contre 2,12 pour le bloc, Manon 20/09) : opt-in seulement
...
# faux par construction (verdict Manon 07 h 20 : « Pointer argument cannot be
...
def test_prefill_moe_marlin_compact_au_bit_avec_le_temoin(monkeypatch):
    ...
    # vide (verdict Manon 07 h 20, model.py:1301). L'état est posé comme
