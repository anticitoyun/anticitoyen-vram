"""Forme (b) de P1 disposition unique (sage-p1-disposition-unique-18-09,
...
def test_le_bloc_moe_decode_prend_gemv_marlin(monkeypatch):
    ...
    # recalculait gate/up par v1 (chaîne if/elif coupée en deux — Laure, 18/09)
...
# contre la division en torch qu'elle remplace (oceane-piece42-glue-22-09 :
