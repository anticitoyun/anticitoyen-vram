"""C13-a (sage-c7-clos-c13-attention-glm-19-09) : TF32 à portée limitée sur les
...
def test_defaut_tf32_prefill_seul_et_portees_opt_in(monkeypatch):
    """sage-c13a-defaut-19-09 § 1 + addendum : sans variable, MLA_CORE=tf32 pose allow_tf32
...
def test_regime_reduit_seulement_sous_2048_cles_vues(monkeypatch):
    """sage-c14-defaut-tf32-8k-20-09 addendum 02 h 25 (verdict-tf32-8k : max |Δ| 6,23 % à 8 k) :
...
def test_regle_des_cles_neutralisee_par_max_cles_zero(monkeypatch):
    """ACVRAM_MLA_CORE_MAX_CLES=0 (bras « règle neutralisée » de la prise à 36 tranches, Manon 20/09) :
