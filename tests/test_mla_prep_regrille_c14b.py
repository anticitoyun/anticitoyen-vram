...
def test_cablage_variable_prep_grille(monkeypatch, grille):
    """ACVRAM_MLA_PREP_GRILLE (Sage 09 h 00 : variable séparée, défaut 0) : le chemin de lot appelle
...
def test_prep_regrille_au_bit_contre_temoin_sur_carte(B, rope):
    ...
    if rope:
        ...
        # une demi-table [max_pos, rope/2] est refusée par le TORCH_CHECK du lanceur (Manon, 20/09 08 h 10)
