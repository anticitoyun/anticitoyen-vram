"""Passage DIRECT d'une source déjà NVFP4 (Sage, revue/sage-convertisseur-formats-16-09.md
...
et le doute § 4 de Sage est tranché par la mesure : requantifier ne
...
def test_convert_passage_direct_ecrit_les_octets_de_la_source(tmp_path, tiny_checkpoint, target_rig):
    ...
    # vLLM) restent en clair, quel que soit le plan (Laure, 17/09)
