"""Défaut du 22/09 (poste2) : sortie vLLM tronquée systématique sur 3/3 fenêtres, silencieusement
...
_CHEMIN = os.path.join(os.path.dirname(__file__), "..", "scratchpad", "poste4-b12-21-09",
