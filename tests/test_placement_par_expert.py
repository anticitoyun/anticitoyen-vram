"""Placement par expert (bead anticitoyen-vram-pds, point 4 — Sage §4) :
...
du contrat de table (`memory/table_adresses.py`) et du noyau de Laurine.
"""
...
def test_chemin_groupe_table_bit_identique_au_chemin_groupe_pile():
    """Suite du point 4 (Jérôme, 13/09) : `_try_build_stacks` ne doit plus
...
def test_repin_sous_graphe_cuda():
    """Suite du point 4 (Jérôme, 14/09) : lever la garde `graphs.py:224`
...
def test_creneaux_fantomes_masques_bit_identique_et_compte_exclu():
    """Bead pds, 14/09 (masquage du remplissage godet, Jérôme) : la sortie
