"""acvram-parc à sec (sage-deb-parc-portable-20-09 § 4) : portabilité, installation à blanc, idempotence, rc ≠ 0.
...
MOTIFS = (r"/mnt/", r"/opt/ia", r"/home/[a-z]+", r"/media/")  # chemins de machine seulement : le nom d'auteur (ids GTK fr.anticitoyen.*) n'en est pas un (Sage 20/09)
