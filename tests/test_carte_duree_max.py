"""carte.sh : plafond de prise ACVRAM_DUREE_MAX (sage-tests-30min-20-09 § 3.1, utilisateur
...
def _lance(tmp_path, duree_max, cmd, type_="etat"):
    ...
    # hermétique (Sage T4) : verrou propre ET aucun marqueur d'enveloppe hérité — sous `carte.sh pytest …` le
