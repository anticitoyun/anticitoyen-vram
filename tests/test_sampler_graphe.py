"""Levier 1 (revue/oceane-levier-1-conception-21-09 § 4 et § 7) : le glouton
...
frontière A/B : Manon. Ce qui doit casser : un noyau qui diverge de
...
def test_defaut_graphe_et_temoin_lent(monkeypatch, capsys):
    """Défaut = graphe (verdict Laurine d145bf0d) ; ACVRAM_SAMPLER_LENT=1 =
