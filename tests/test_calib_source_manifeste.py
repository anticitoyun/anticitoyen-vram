"""Sage (`sage-corpus-16-09.md` § 8) : le manifeste doit porter le nom + le
...
def test_sans_fichier_fourni_le_corpus_integre_est_identifie():
    """Le corpus intégré est un FICHIER du paquet (Gutenberg #1342, Sage
    sage-calibration-verdict-17-09) : nom et sha256 du fichier réel."""
...
def test_le_manifeste_porte_ce_que_la_calibration_a_rendu():
    """Sage : calib_seqs/calib_tokens = ce que load_calib_ids a RÉELLEMENT
