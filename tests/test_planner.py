...
def _tier_5090(link_gbps: float = 26.8) -> Tier:
    ...
    # 13/09 (Sage) : `detect.py:vram_bandwidth_gbps` prenait le pic, ce qui
...
def test_le_plan_rend_le_maximum_de_contexte_qui_tient_pas_le_plus_petit(tmp_path, target_rig):
    """Sage sage-s2-k48-feu-vert-21-09 (addendum) : la colonne 262 144 ne demande pas « tient-il ? » mais
