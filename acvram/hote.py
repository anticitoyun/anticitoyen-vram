"""Réglages hôte génériques du moteur (0.6.31, sage-tests-rapides-cloture § 2 via Jérôme 09 h 52).
...
`os.sched_getaffinity(0)`), jamais les demandées. Prédiction (Sage) : OMP 8 ne bouge aucune
