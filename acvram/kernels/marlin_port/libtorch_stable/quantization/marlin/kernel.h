// Port acvram (23/09, pièce 101) de vllm/csrc/libtorch_stable/quantization/marlin/kernel.h, v0.29.0 (Apache-2.0,
// voir LICENSE-vllm), inchangé.
...
#define MARLIN_KERNEL_PARAMS                                                   \
  const int4 *__restrict__ A, const int4 *__restrict__ B,                      \
      ...
      int max_shared_mem, int gs_par_colonne  /* port acvram, pièce 101 */
