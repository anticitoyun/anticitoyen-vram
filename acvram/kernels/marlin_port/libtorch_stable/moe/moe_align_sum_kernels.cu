...
// vllm/csrc/libtorch_stable/moe/moe_align_sum_kernels.cu — licence Apache-2.0 (voir ../../LICENSE-vllm et NOTICE). Modifications : voir NOTICE.
#include <array>
#include <cub/cub.cuh>

#include <cuda_runtime.h>
#include <torch/csrc/stable/macros.h>
#include <torch/csrc/stable/library.h>  // Port acvram : STABLE_TORCH_LIBRARY_IMPL
...
// Port acvram : enregistrement de l op dans l espace `acvram_marlin` (le schéma est dans bindings.cpp).
STABLE_TORCH_LIBRARY_IMPL(acvram_marlin, CUDA, m) {
