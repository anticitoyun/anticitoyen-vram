...
def _nvml():
    ...
    Ajout GUI n°3 (sage-gui-ajouts-18-09) : `nvidia-smi
...
class AnneauEnergie:
    ...
    Correction (sage-metrics-energie-fenetre-18-09) : la première version
    ...
    DEUX valeurs différentes sur la MÊME fenêtre réelle (trouvé par Laure
    ...
    def jetons_fenetre(self) -> int:
        ...
        deux échantillons ou si le compteur n'a pas bougé. Sage
        (sage-metrics-energie-fenetre-18-09) : `j_par_jeton()` rend None
