...
class Tokenizer:
    ...
    def prefixe_gabarit(self) -> str:
        ...
        TOUTE conversation. GLM-4.x : ``[gMASK]<sop>`` (Sage § 10, cause
        trouvée par Laure : sans ce préfixe le modèle n'a aucun puits
    ...
    def encode_brut(self, text: str) -> list[int]:
        ...
        # Garde (Sage) : n'injecter que si le littéral s'encode ENTIÈREMENT en
...
# (Gemma 4 : image_position_ids [n, patches, 2] — sans elles get_image_features casse, Manon 14 h 40 ;
