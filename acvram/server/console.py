...
async function rafraichir() {
  try {
    ...
    // Ajout n°2 (sage-gui-ajouts-18-09) : un compteur > 0 noye dans le
    ...
    // Ajout n°3 (sage-gui-ajouts-18-09 § 3) : J/jeton, integre cote serveur
    ...
    // Ajout n°4 (sage-gui-ajouts-18-09 § 4) : la meme ligne "[régime] ..."
...
// -- verrou de la carte -----------------------------------------------------
// « Une annonce a une minute de retard, une fenetre GUI non » (sage-gui-
...
// « affiche < 5 s » (sage-gui-ajouts-18-09) : un verrou pris par un temoin
