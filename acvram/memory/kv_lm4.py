...
# ---------------------------------------------------------------------------
# Deux interrupteurs de diagnostic (sage-kv-lm4-clos-17-09 § 1) : lm4 clos
# comme réfuté (verdict-kv-lm4-qualite-17-09, écart × 10 au seuil), cause pas
# encore lue. Trois bras à 25 min de carte (Laure) décident seulement si
# tq3+1 s'écrit après le commit B de Laurine — ils ne rouvrent PAS lm4.
