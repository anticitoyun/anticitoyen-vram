...
VARIABLES: tuple[Variable, ...] = (
    ...
    Variable("GEMV_SPLITK", "1", None, "0",
             "GEMV Marlin (b) : split-K par lot aux petits lots (gate/up b=1 : 96 → 384 blocs, réduction du dernier bloc, déterministe) ; 1 défaut depuis 0.6.37 = S auto (+7,09 % b=1, KL 5/5, revue/manon-piece67-23-09.md) | 0 = noyau d'avant (témoin) | ≥ 2 = S forcé (8 : moins bon que l'auto)"),
