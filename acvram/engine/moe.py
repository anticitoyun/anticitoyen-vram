...
class MoEBlock(nn.Module):
    ...
    def _try_build_stacks(self) -> bool:
        ...
        def one(nom, projs):
            ...
            # Échelle AWQ PAR EXPERT dans la pile (poste7, poste7-glm-awq-pile-15-09) :
...
# servies par le tensor, le GEMV Marlin et le préfill Marlin — AU DÉFAUT (209 c : Coder i8c +5,77 % b=8). La 220 (25/09)
