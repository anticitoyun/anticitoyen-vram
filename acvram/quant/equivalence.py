...
fixe ne juge pas : poste3 (15/09, revue/verdict-narrow-voyants-15-09.md)
...
`verdict_decodage` (poste7 §7.2, revue/poste7-reprise-15-09-b.md) : le test
...
# -- mode décodage (poste7 §7.2) : le témoin remplace le nombre fixe --------
...
def verdict_decodage(
    ...
    """poste7 §7.2 : B/A doit DOMINER un témoin mesuré au même lancement
