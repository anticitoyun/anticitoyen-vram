# Vis-à-vis décodage b=12 : acvram vs vLLM, par poste (14/09, Laurine)
...
vLLM : invites 256 + 200 décodés, profil de Manon,
...
3. 12 jetons / 14,5 ms = 828 t/s ; le duel mesure 569 : **6,6 ms par pas
   (31 %) ne sont pas dans le rejeu** (banc HTTP de Laure, ordonnanceur,
...
lm_head, norm/glue), < 20 % dans le MoE (fantômes masqués par Océane).
...
Condition de qualité : PPL (Manon) ≤ +0,5 % sur le total — l'« attention
