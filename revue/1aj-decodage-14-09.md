# 1aj décodage — projections d'attention et lm_head en NVFP4 (à sec, 14/09, poste4)

Ordre de poste7 (`revue/poste7-point0-ordre-14-09.md`) : poids q/k/v/o (et lm_head,
...
poste2, 14/09 (`verdict-a6-int8-snrfloor0-14-09.md`) : reconversion
...
+8,79 % (l'issue de poste7 : q/k). Le débit −93 % d'A6 était un autre défaut
...
restent NVFP4 même sous le plancher. Quatre conversions à faire (poste2,
...
|---|---|---|---:|---:|---|
| A | q_proj, k_proj | v, o, lm_head | 2,30 − 0,33 = 1,97 | **3,6** | ≤ ×1,01 si l'issue de poste7 est la bonne |
...
Rien de ceci n'a besoin de la carte avant les quatre conversions de poste2.
