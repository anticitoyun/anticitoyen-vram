# (5) MoE en MMA groupée au décodage, pas complet sous graphes (14/09, 10h48-11h08, poste4)
...
Levier (3) de poste7 (`poste7-moe-mma-decodage-14-09.md` § 3, seuils rescellés
sur la référence 20 s de poste3 19,0 ms / 630,7 t/s / 0,619 J).
...
moe_reduce_trie) rendu CAPTURABLE : grille de tuiles fixe d'poste1
...
tampon) + `tests/test_moe_mma_decodage.py` (condition (i) de poste7).
...
graphes/eager du chemin GEMV (poste1, `graphes-preparer-divergence-14-09.md`,
