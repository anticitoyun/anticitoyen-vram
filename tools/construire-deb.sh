...
if [ ! -x "$VENV/bin/acvram" ]; then
    ...
    # 0.6.33 (sage 20/09 14 h 10) : la tour de vision (Gemma 4, Qwen3-VL) passe par les classes
...
# Éco d'horloge par défaut (sage-eco-2700-defaut-19-09, décision utilisateur
