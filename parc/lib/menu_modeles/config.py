...
# `GUI_TEST {…}` puis la fenêtre quitte ; rc 2 si le bouton n'existe pas. Laure le joue sous Xephyr/Xvfb.
...
# alias sans fiche dans notes-modeles.tsv : jamais « ? » (sage-menus-cloture-19-09 § 1)
