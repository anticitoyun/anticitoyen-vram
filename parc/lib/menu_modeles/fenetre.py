...
class Fenetre(Adw.ApplicationWindow):
    def __init__(self, app, profil):
        ...
        self.filtre_vedettes = False          # ≈Opus / ≈Fable (sage-menus-vedettes-19-09 § 4)
    ...
    def _construire(self):
        ...
        # puces vedettes (sage-menus-vedettes-19-09 § 4) : premier mot-clé d'usage de la fiche
    ...
    def _passe_filtre(self, m):
        ...
        if self.filtre_texte:
            ...
            # pas (décision Maîtresse 21/09). Le reste du texte reste substring.
    ...
    def commande_claude(self, m):
        ...
        l'affichage (Sage 21/09 : deux constructeurs = une ligne qui peut mentir)."""
