...
Océane, à sec, ordre Sage (`revue/sage-avis-exterieur-16-09.md` § point 2,
repris le 17/09 par `revue/sage-plan-completion-comparatif-17-09.md` § 3,
...
gain attendu exil ×9 → ×2-3 (`sage-avis-exterieur-16-09` § point 2)
tient.
...
`sage-plan-completion-comparatif-17-09` : pas de carte avant la fin du
...
un seuil plus bas, p. ex. 40 %, à chiffrer si Sage le demande).
