# Pièce 98 — KL 0,81 à b=4 en lot mêlé : BRUIT D'ORDRE du MoE groupé au préfill, pas une contamination — 23/09 (poste1)

* **instrument** : `scratchpad/poste1-p98-23-09/composition.py`, dérivé de kl-b.py (p81/p82/p97) : Coder qkvo-i8c, défaut du jour, eager, teacher forcing 8 pas, 5 dumps HF.
