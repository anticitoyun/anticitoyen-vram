...
poste3, 16/09/2026, 06:16-06:22 (unité b5-poste3), une prise de carte. Ordre :
poste7 [`poste7-ordre-16-09.md`](poste7-ordre-16-09.md). Protocole scellé :
[`protocole-cellule-b5-16-09.md`](protocole-cellule-b5-16-09.md) (poste3
ef0ea3e). Arbre : travail/poste3 figé à ef0ea3e (= main b6e8d3a, v0.6.5,
...
4,1 % (hors bruit, 10× l'écart intra-bras). Critère de poste7 tenu :
...
plafonne). Pour le godet 8, MMA = même débit, −4 % de J. À poste4 pour
