...
Manon, 15/09. Suite de `verdict-1aj-variantesAC-15-09.md` (q/k innocentés,
...
« repli lm_head seul » que Sage avait posée comme option de repli
propre — elle s'avère être la MEILLEURE option, pas un simple repli.

## Suite

Rendu à Jérôme/Sage : D recommandée pour 1aj décodage. Débit réel
