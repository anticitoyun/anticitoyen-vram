...
Demande Manon : lire les fenêtres brutes acvram b=1 de `sorties-energie/` (passages 3
...
probablement le « passage 5 » compté par Manon en excluant les échecs précoces)**.
...
## Conséquence proposée (pas encore codée, à trancher par la Maîtresse/Manon)
...
## Mise à jour 22/09 18 h 3x (Laurine, à sec) — la chauffe réfutée, ET un bogue de lecture trouvé

**Réfuté (Manon 0ba60ca4)** : chauffe posée (`jetons_chauffe` publié, 256 vus sur les
...
- **croissante** (les premières sondes plus lentes) → chemin froid propre à CETTE
  ...
  chauffe 20 s ou fenêtre b=1 de 40 s (pistes de Manon) ;
- **dispersée sans tendance** → pas un warm-up du tout ; chercher une gigue de
  ...
  à 2 requêtes en vol pour voir si ça change la variance, autre piste de Manon) ;
- **périodique/alternante** → signature d'un mécanisme cyclique interne (ex.
  recapture de graphe, libération VRAM périodique) — hors des trois pistes de Manon,
  nommé si observé.
