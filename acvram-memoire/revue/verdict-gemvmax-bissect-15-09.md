...
Laure, 15/09/2026, 17:28-17:51, deux prises de carte (bissect-laure 17:28-17:36,
bissect2-laure 17:37-17:51). Ordre : Sage
[`sage-1aj-decodage-15-09.md`](sage-1aj-decodage-15-09.md). Protocole scellé :
...
Seuil Sage (≤ 16,4 ms, réfuté > 16,9) : **RÉFUTÉ** ; ma fourchette
...
Laurine (GEMV NVFP4 par tranches) est la seule voie, il n'y a pas de
réglage.
...
Prédiction Sage (≥ 0,2 ms, réfuté < 0,1) tenue à 0,013 près ; la mienne
...
lancement, pas du calcul (Sage : 0,2-0,4 prédit sur le même
raisonnement). À b=12 le même surcoût est noyé (16,25 ms de pas).

**Correctif (Sage, à Océane)** : fp32 seulement là où l'équivalence GLM
