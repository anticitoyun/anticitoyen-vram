...
scellé (Jérôme 06 h 54 / REGLES § 3, avant) : régime `eco=2700(...)` juste, `-rgc` à l'arrêt, pas de charge résiduelle, charge utile passée
...
suite : Jérôme : feu vert d'installation 0.6.27 ; ma file : gemma:2 + coder:0 (9 tranches) → β 9 tranches → gemma capture
