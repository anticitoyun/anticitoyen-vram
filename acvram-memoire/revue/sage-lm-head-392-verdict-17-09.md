# Sage — lm_head Triton : scellé NON tenu (392 < 400, bande orpheline lue contre), mécanisme confirmé au chiffre près → DÉFAUT et cellule publiée telle quelle ; fusion de la réduction ensuite, puis GEMV experts (17/09)

Entrée : Laure ef9f8bd — Qwen3.8 b=12 **392,3 t/s, 1,02 J** (palier 1 349 : +12 %, = les 5,6 ms de GEMV fp32 retirées, exactement), b=1 70,0 (± 3 % tenu), `ppl-decode-kv` 4,0882 (tenu) ; rondes bridées 400 W, nu en fenêtre courte 415. Profil : `_dense_etroit` 65 %, `_reduire_kernel` 12 %.
