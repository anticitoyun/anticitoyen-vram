...
Océane, à sec (aucun GPU), ordre Sage §3 (main da2290f,
`revue/sage-glm-pile-correctif-16-09.md`), suite au plancher bas écarté
...
Laurine : corriger `nvfp4_quant_act_kernel` (ou son usage pour `down_proj`
...
scellé ≤ 1,010 dans le même commit (ordre Sage, `sage-glm-mma0-verdict`
§3). Manon attend.
