...
poste2, 15/09. Protocole poste4 (`revue/1aj-decodage-14-09.md`), même
...
Exactement la condition de réfutation nommée par poste4 (« A > ×1,015
...
q,k NVFP4) — mais poste4 notait que le gain d'octets/ms de C (1,88
...
Rendu à chef/poste7 : C est la seule des deux à tenir la qualité,
...
la variante A' (note poste4) pour isoler lm_head de v/o.
