...
| S1 cache PCIe, routage concentré | 0,70 | 27 + 3 | 33 | gagne seulement si h ≥ 0,55 (parité) — le h de Sage |
...
## 3. Mesures qui invalident les bornes, avant tout code (Manon)
...
* Coût : commits 1-3 ≈ une session Océane à sec + 2 prises Manon ≤ 30 min ; 4-6 ≈ deux sessions ; graphes/prefill/vision hors devis.
