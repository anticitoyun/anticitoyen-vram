# Frontière (2) : frontiere-pas.py A B B A sous ACVRAM_SAMPLER_GRAPHE — TENU — 22/09 (Manon)

* instrument : `outils/gpu/mesure/frontiere-pas.py` (worktree manon-w-21-09, main à jour), 4 processus séquentiels A0/B0/B1/A1, Coder nvfp4 défaut, b=12, ctx 2048, 300 pas pleins chacun
...
* scellé (Océane, `oceane-levier-1-conception-21-09` § 5) : tenu ssi `echantillon + trou_gpu` (médiane, 300 pas) baisse ≥ 30 µs entre A et B ; réfuté si < 30 µs ; alarme si gain > 1,4 % du pas (mesurerait autre chose)
