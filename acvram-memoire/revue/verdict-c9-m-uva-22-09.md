# C9 M-UVA — TENU, 23,6 Go/s — 22/09 (poste2)

* instrument : `outils/gpu/mesure/c9-m-uva.py --rep 200` (harnais dédié poste1, remplace le chronométrage non concluant de `verdict-m-uva-22-09`), sous carte.sh
...
* scellé (poste1, § 3.0) : prédit 15,0-19,0 Go/s ; vaut la peine ssi ≥ 17,0 ; arrêt si < 13,0 ; contrôle d'exactitude UVA==VRAM au bit
