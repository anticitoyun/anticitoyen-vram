...
scellé (Sage, sage-c9-119b-cache-experts § 2 M0, avant) : 18,7 Go/s ; > 40 → tous les coûts ÷ 2,8 et les tiers réécrits (1 792 → 1 050)
...
suite : Sage : recaler les lignes M2/M3/C9-cellules sur 22,6 (pas 18,7, pas 52,8) ; Océane : le chemin d'exil doit copier depuis de l'épinglé (13,9 en paginable D2H) ; ma file : cellule llama.cpp 119B b=1 experts en RAM (concurrent de référence), puis fin de nuit
