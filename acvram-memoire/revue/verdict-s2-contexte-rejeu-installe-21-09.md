# S2-contexte rejoué sur le paquet installé (0.6.34) — 21-22/09 (poste2)

* instrument : `scratchpad/s2-contexte-20-09/chaine.sh` (3 prises), worktree `poste2-665eeacc-21-09` pinné exactement au commit du `.deb` installé (`665eeacc`), `PYA -m acvram.cli serve` — équivalent au binaire installé, « le code ne change pas entre les deux »
...
* mesuré : **12 TENU** / 5 DEFAUT-CHAUFFE nommés (GLM-k48-calibA, GLM-Flash base, GLM-Grande, Qwen3.5-35B, Qwen3.8-27B-calibA) / **2 DEFAUT chauffe-clampée** (Qwen3-Coder-i8c ctx_tenu=11264<15360, connu et tranché par la chef ; Kimi-Linear ctx_tenu=14336<15360, même mécanisme, nouveau cas) — **0 REFUS budget KV** et **0 « 500 malgré chauffe tenue »**
...
## Suite
Pièce (3) de la chef close. Kimi-Linear (chauffe clampée à 14336 sur 15360 demandé) à nommer par poste1 comme les autres DEFAUT-CHAUFFE — même mécanisme, pas de diagnostic supplémentaire ici.
