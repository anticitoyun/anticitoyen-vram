...
Manon, 14/09/2026 soir. Détail complet, tableau des 16 positions et
discussion : `revue/verdict-equivalence-glm-2couches-14-09.md`. Cette
note résume pour la suite.

## Protocole

Seuil scellé par Sage (`revue/sage-lancement-14-09.md` §2) : max
...
(`glm4_moe_lite` natif, venv vLLM). Sur le correctif MLA d'Océane fusionné
...
charge par Océane (couche 0 dense+MLA seule, puis routage MoE GLM :
