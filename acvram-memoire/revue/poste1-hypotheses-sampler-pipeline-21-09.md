# Sampler vectorisé : −33,5 µs isolé, −2,2 % en service — trois hypothèses à sec (poste1, 21/09)

instrument : lecture de `verdict-banc-sampler-665eeacc-21-09` (lent 55,1 µs / lot 21,6 µs), `verdict-sampler-b12-6f-v2-21-09` (A 1 541,9 · 1 538,9 ; B 1 506,2 · 1 471,9 · 1 522,5), `scratchpad/poste4-b12-21-09/chaine-sampler-6f-v2.sh`, `engine/pipeline.py`, `engine/sampler.py` ; 0 min de carte
...
* mesure (poste4, ≤ 3 min de carte) : nsys de 50 pas en A et en B (instrument `poste4-b12-21-09/nvtx-glue-h2.py`), lire le TROU de carte entre le dernier noyau du pas n et le premier du pas n+1 : prédit égal à ±20 µs ; H2 si le trou est plus long en B de ≥ 150 µs.
...
Décision proposée : H1 d abord (8 min) ; si elle tient, le sampler vectorisé n est ni gain ni perte mesurable à b=12 (0,4 %) — le remettre en défaut n apporte rien, le laisser en opt-in ne coûte rien ; l écart à vLLM (3,5 %) est ailleurs (H2 de poste4 : frontière 0,43 ms = 5,5 % du pas, dont l échantillonnage n est que 55 µs).
