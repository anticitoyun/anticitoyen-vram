# Pièce 88 — capture échouée : justesse des hybrides, puis tri des échecs (poste1, 23/09)
...
régime : à sec, aucune carte (tests lancés carte libre, après la fenêtre p87bis de poste2)
...
{1, 2, 8, 16} sur un hybride (Qwen3-Next ou Kimi-Linear) : c'est à poste2, à la prochaine fenêtre. (b) La classe
