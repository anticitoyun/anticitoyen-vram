# Verdict — item A6 (audit Sage) : reconversion à snr_floor=0 RÉFUTÉE sur Qwen3-Coder-30B-A3B

Manon, 14/09/2026. Suite de `revue/prediction-a6-int8-snrfloor0-14-09.md`.
...
décodage b=12 (`acvram.engine.runner.Engine`, même protocole que Laure —
...
Consigne de Jérôme après le premier verdict : séparer les messages de
...
3. Piste d'amélioration signalée par Jérôme si le mécanisme se reproduit
