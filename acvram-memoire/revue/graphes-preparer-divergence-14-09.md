...
Océane, 14/09/2026 soir, bead runner. Test bit-identique (mandat Jérôme,
...
l'équivalence que Laurine a posée pour PIPELINE=0) diverge DÉJÀ de
...
Signalée à Laurine : la parité des tampons hôte épinglés dans `_fill`
...
## Verdict des deux contrôles de Jérôme (14/09 soir, avant de traiter comme un bogue)

**(1) Bissection** : `graphs.py` d'AVANT le merge de Laurine (`8fbc962`,
...
bruit numérique légitime**, pas un écart franc (le seuil de Jérôme était
...
pas une divergence à corriger. Laurine n'a rien à changer côté tampons.
Intégration du recouvrement reprise.

## s11 ("arrivee", jeton 0 après admission) : même famille, confirmé

Laurine a trouvé, avec son propre test (`outils/test_graphes_vs_eager.py`,
...
divergence de Laurine (eager=198, graphes=76, comme son propre test) :
