...
[`poste7-poste3-15-09.md`](poste7-poste3-15-09.md) (main b516eb4), transmis par
chef. Code mesuré : main du jour (b516eb4 ≥ 92beffe), chemin
`_forward_grouped_mma` (`model.py:1174`), constantes `model.py:1290-1291`.

## Seuils de poste7 (repris tels quels)
...
## Montage
    ...
    ties       12 invites × 128 jetons (`invite(k)` d'poste1), 256 jetons
...
* Certifié : A 18,5-19,5 ms (le 14/09 en rondes ctx 2048 : 630,7 t/s =
  19,0 ms/pas, PAS 15,9 — la fenêtre de poste4 était un autre montage ;
