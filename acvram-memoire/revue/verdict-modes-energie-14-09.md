...
poste3, 14/09/2026, 10:38-10:46. Protocole et prédictions scellées avant :
[`protocole-modes-energie-14-09.md`](protocole-modes-energie-14-09.md) (poste3
9fbf481). Décideuse : poste7
([`poste7-modes-energie-14-09.md`](poste7-modes-energie-14-09.md), P5 dans
[`poste7-veille-trtllm-ggrun-14-09.md`](poste7-veille-trtllm-ggrun-14-09.md)).
...
partagée : à refaire si poste7 veut un moyen certifié, ~3 min.
...
* **max** : test d'acceptation de poste7 (t/s ≥ 1,08 × moyen = 681) **TENU** à
...
* **eco** : test de poste7 (J ≤ 0,90 × moyen = 0,557) **NON TENU** à b=12 :
...
* **Repos chaud (question de poste7 : attente active ou P0 ?)** : ni l'un ni
...
Seuil de poste7 « chute ≤ 30 % à 512, ≥ 70 % à 8 192 » : la seconde moitié
