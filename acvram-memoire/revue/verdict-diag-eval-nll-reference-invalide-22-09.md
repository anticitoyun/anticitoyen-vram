# diag-eval-nll, épreuve de la référence HF (correctif) — RÉFÉRENCE INVALIDE, P3 retiré — 22/09 (poste2)
...
## Suite
Corriger le montage de la référence (gabarit de conversation, BOS, ou offload HF) avant tout nouveau rejeu sur Gemma 4 — à poste1. Aucune conclusion sur le moteur acvram n'est valide tant que cette étape échoue.
