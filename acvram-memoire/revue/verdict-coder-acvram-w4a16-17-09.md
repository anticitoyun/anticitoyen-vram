...
commit : arbre poste3 fd1e204 (PPL) et cecfb18 (rondes, prefill) = main ≥ 0971c90 (défaut `ACVRAM_PREFILL=bf16`) ; converti `Qwen3-Coder-30B-A3B-nvfp4` (aucune calibration, awq=False ; « non concerné » par le W8A8 tacite selon l'outil de poste4)
...
scellé (poste7) : PPL privé 1,016-1,020 (classé) · b=12 780-850 t/s · J 0,50-0,53
