...
Océane, à sec, ordre Sage (`revue/sage-poste-d-verdict-17-09.md` § 2), sur
un bogue trouvé par Laure (`certifie-b12`, `cead3cb`).
...
* `scratchpad/certifie-b12-15-09.py` et `certifie-b12-duree-15-09.py`
  (Laure/Laurine) : passent `max_concurrent_seqs=B` à `load_model` — le
  contournement `CERT_PLAN_LEN` (gonfler `max_model_len` pour compenser)
  disparaît, comme prévu par Sage. Les deux refusent désormais de publier
...
## Pour REGLES § 3 (proposition, à trancher par Jérôme/Sage)
