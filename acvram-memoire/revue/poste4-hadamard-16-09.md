# poste4 — rotation de Hadamard à l'exécution (ordre poste7 `poste7-hadamard-16-09`), 16/09

Périmètre : poste2 tourne les poids d'experts (W·H, `hadamard_block: 512` par tenseur, sans AWQ
...
## Ce que poste2 doit écrire pour que ça tourne
...
## Scellés (poste7 § 4) et prédiction
...
ms/pas (poste7 +0,3) — à mesurer, témoin = converti non tourné.
