...
poste2, 15/09 soir. Correctif réel (voir `verdict-glm-regime-degrade-
15-09.md` pour l'erreur écartée avant celui-ci) : AWQ n'est plus jamais
cherché pour un tenseur d'expert MoE. Test d'acceptation chef :
...
plus que les « ≤ +0,3 % » prédits par chef avant mesure. Retirer AWQ
...
Rendu à chef/poste7 : le converti actuel (sans AWQ sur les experts,
...
comme tel (règle de poste7 du 15/09 §2) jusqu'à ce travail ? Je n'ai pas
