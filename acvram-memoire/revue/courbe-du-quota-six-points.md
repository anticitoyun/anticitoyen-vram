...
gros ? Relevé par Jérôme, converti, et l'inversion tient — mais le facteur
global vaut **5,4 et non 16**.

```
segment              n    bits   milli-PPL   /tenseur   bits/tens   milli-PPL PAR BIT
  0 ->   6  (Laurine) 6  0,0551      1,10      0,183     0,00918          19,96
172 -> 198  (Oceane) 26  0,6415     20,70      0,796     0,02467          32,27
198 -> 225  (Oceane) 27  0,7133     77,40      2,867     0,02642         108,51
...
Proposition de Jérôme, meilleure que mon attente : à **budget constant**, même
...
**Le témoin plafond de Laurine reste utile pour autre chose** : il tranche : une conversion à
...
**Deux colonnes, pas une** — remarque de Jérôme, et elle est juste : une colonne
...
Mesuré par Laurine, et les 128 octets d'écart qu'elle attribuait au bruit sont
maintenant **nommés** :
