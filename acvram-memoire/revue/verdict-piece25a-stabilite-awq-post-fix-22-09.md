# Pièce 25(a) awq-stabilite-experts, rejoué après correctif (bd5c7932) — TENU, seuil ≥512, pas 32-127 — 22/09 (Manon)
...
* commit : main/manon à jour (8b68082b), correctif lecteur à 3 dispositions (bd5c7932) déjà fusionné
* régime : 3 collectes (100/1000/10000 jetons), tolérance 0,10, échantillonnage stratifié par classe de jetons routés
* scellé (Océane) : seuil de stabilité attendu classe 32-127 ; critère groupe (22/09, avis croisés) : stable à partir de ≥256 obs/expert (erreur-type ≈6 %), ≥512 pour les hétérogènes
