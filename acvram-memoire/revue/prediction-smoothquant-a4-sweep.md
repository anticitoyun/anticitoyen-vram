...
poste2, 13/09/2026. Suite du verdict A4 nu
(`revue/verdict-a4-fakequant-llama2-7b.md` : PPL 5,7550, +2,58 %, seuil
dépassé). Hypothèse de chef : un lissage SmoothQuant (calibration
...
(chef). ~1 h par régime × 4 = ~4 h, ou sous-ensemble via `--regimes`.
