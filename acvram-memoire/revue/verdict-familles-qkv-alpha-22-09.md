# familles-noyaux sur l'alias qkv-alpha-22-09 — marlin presque complet (47/48), pas encore comparable — 22/09 (poste2)
...
## Suite
Identifier la couche restée hors Marlin (probablement encore un expert sous-calibré malgré `--obs-min 0`, ou un cas limite de la fusion gate/up) avant l'ABBA — à poste1, ou je peux chercher si le groupe préfère. Sans cette dernière couche réglée, la pièce 42 reste ouverte.
