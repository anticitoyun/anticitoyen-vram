# Pièce 92 — attention : le découpage n'est PAS le levier (réfuté au banc) ; réduction déroulée au bit par défaut (−1,9 %) ; 4 warps −5 % au banc mais contredit par le servi du 20/09 — 23/09 (Océane)
...
* **verdict** :
  ...
  4. **4 warps** : −5,1 % au banc (−0,038 ms/pas ; −15 % à b=1 ctx 2 048). Mais le défaut 8 vient d'un ABAB SERVI (Manon, 20/09 05 h 15 : B8 +11,5 % contre B4 +9,1 %, `regime.py`). Le banc et le servi se contredisent ; **ne se tranche qu'en service, par Manon**. Je ne le passe pas au défaut.
