# Verdict — PPL EXL3 Coder-30B (converti poste2 4,25 bpw) : 1,0006 × bf16 privé, 1,0004 public — le meilleur bras de la table, de loin
...
commit : arbre poste3 8645fee (= main c34aed5) ; converti `models_exl3/Qwen3-Coder-30B-A3B-Instruct-EXL3-4.25bpw` (poste2, exl3 1.4.8, `bits 4.25, head_bits 6, calibration rows 250 × cols 2048`, 16 Gio)
...
## Table Coder-30B, PPL × bf16 (géo, 3 tranches), classement ≤ 1,02 sur le privé
    ...
    EXL3 4,25 (poste2)                  4,28/6,0   1,0006    1,0004    oui
...
## Bornes
- Calibration EXL3 : 250 lignes × 2 048 du jeu interne d'exllamav3 (contenu non publié par nous ici ; à écrire avec son sha256 si poste7 l'exige — poste2) ; le privé est disjoint par construction, et il est à 1,0006 : le résultat ne dépend pas d'un recoupement.
