# banc-marlin-plancher (Océane 660b4a36), synthétique + routages réels — TENU littéralement, mais 8 couches PERD au lieu de gagner — 22/09 (Manon)
...
* commit : main à jour
* scellé (Océane) : gateup/down isolés 1,45-1,55 To/s ; 8 couches = couche ± 1 µs ; L2 ≤ 2 % ; réfuté si couche ≥ 1,55 (rien à faire dans Marlin) ou 8 couches gagne > 3 µs
* mesuré :
