...
Océane, à sec (aucun GPU), ordre Sage (main 86b152b,
`revue/sage-glm-pile-correctif-16-09.md`), suite au discriminateur
...
position 8/préfixe 9 jetons (`oceane-equivalence-pile-gateup-16-09.md`).
Laurine : chercher directement dans `model.py:983`
