# Protocole — bloc 2 bis : re-PPL alpha-commun avec le noyau par ligne (Sage § 7), contrôle des 25 s, PPL du reconverti -k48

Laure, 16/09/2026, avant mesure. Ordre : Jérôme (Sage § 7, main d1b103a). Arbre :
**travail/laure-qa @ 877169c** (branche laurine : échelle globale par ligne
...
= `acvram.evaluate.perplexity` avec la ligne de Manon (wiki-gptq, 2048/2048,
...
Durée ≈ 4 × (chargement + fenêtres) ≈ 6-8 min, unité `reppl-sage7-laure`.
