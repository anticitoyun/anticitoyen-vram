...
poste1, à sec, ordre poste7 (main 6c7cfd9). Les deux IDs cités par chef ne
...
BF16 **au sein du même moteur** (TRT-LLM ou vLLM). Le ×1,46 de poste3 =
...
## Signalé pour poste3 (modèles qu'on a)
