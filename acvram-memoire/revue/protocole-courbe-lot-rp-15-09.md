...
Laure, 15/09/2026, avant mesure. Ordre : Sage § 3 (main 8dc6237), transmis
par Jérôme. Moteur : main 8dc6237 (v0.6.4 + route+pack b451ede,
`ACVRAM_MOE_ROUTE_PACK=1` par défaut, `model.py:1348` ; `MIN_T` 9,
`:1346`). Carte après Océane (5 min).
...
## Critère et prédictions de Sage (rescellées)
...
(+2,5 à b=1). Route+pack retire ~2 200 lancements/pas à b=12 (Laurine :
...
Sage d'avance ; réfuté (mon bord) si b=4 ≤ 1,02× (alors la quantification
