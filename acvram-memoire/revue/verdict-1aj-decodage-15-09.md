...
poste3, 15/09/2026, 17:06-17:17, une prise de carte (1aj-poste3, 623 s, après
397 s derrière la conversion GLM de poste2). Ordre : chef ; seuils poste7
...
(poste3 ce93dc9). Moteur : main 8d24a83 (v0.6.3, MMA au godet ≥ 12), défaut.
...
**poste7, b=1** : ms ≤ 3,6 (réfuté ≥ 4,0) → **RÉFUTÉ** (4,30) ; J ≤ 1,10
...
## Trois états
    ...
    b=1   RÉFUTÉ (poste7 3,6 / 1,10) — relatif −4 % ms, −7 % J ; point 0 non repris (1,40 vs 1,17-1,39)
