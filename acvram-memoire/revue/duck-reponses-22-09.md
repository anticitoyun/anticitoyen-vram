...
**Donnée additionnelle (chef, reçue pendant génération)** : notre noyau nvfp4 étroit tourne à 0,44-0,46 To/s à M=12 (10,2-10,8 µs), donc pas plus vite que notre int8 qui lit deux fois plus d'octets.
