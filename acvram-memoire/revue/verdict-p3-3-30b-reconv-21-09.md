# P3 (3) Qwen3-VL-30B reconverti (correctif experts groupés, carte visible) — 21/09 (Manon)

* instrument : `scratchpad/mm-qvl-20-09/chaine-p3-3.sh` (worktree manon-w-21-09), référence `ref-30b-bf16.pt` réutilisée (sha256 08733794711e, non recalculée)
...
* scellé (Sage 20/09) : « non établi pire que 3 % à 2 SE » — tenu ssi `haut_2se_pct` ≤ 3 %. Issue nommée d'avance (H1 Océane) : « > 3 % = plafond de la source AWQ, à écrire, pas à diagnostiquer »
...
## Suite
Pièce (1) de la Maîtresse close : reconversion réussie côté format (nvfp4, garde convert.py:2280 corrigée) mais la qualité reste bloquée par l'échec de calibration (0 tenseur avec stats, `acvram/quant/collect.py`/`setStorage`) — hors mon domaine, à nommer par Océane avant tout nouveau chiffre de qualité sur cet alias. P3 (4) TENU (seuils H1), P3 (3) RÉFUTÉ. Pointeur transmis à la Maîtresse.
