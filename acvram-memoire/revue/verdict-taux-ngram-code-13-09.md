# Verdict — taux d'acceptation n-gram sur code, Coder-30B (item A4, audit poste7)

poste3, 13/09/2026. Génération réelle (systemd-run, verrou, 20 invites de
...
négatif. **L'inquiétude de l'audit de poste7 (« le défaut ngram pourrait
...
Item A4 de `poste7-audit-connaissances-14-09.md` : **traité**, mais pas fermé
