# Verdict — instrument PPL décodage à 12/12 séquences (Sage § 12.3) : cause de la troncature = allocateur par défaut de l'Engine sur les modèles MLA
...
commit : arbre laure 780a067 (main 3082bda fusionné)
régime : GLM `-k48`, W4A16, SLOTS=12, préfixe `encode_brut`, tranche 0 privée, 12 séquences × 2 047 cibles ; une seule prise de validation d'instrument (la PPL obtenue n'est pas publiée : le chemin décodage attend le correctif de Laurine)
...
## Ce que ça touche hors instrument (Laurine)
