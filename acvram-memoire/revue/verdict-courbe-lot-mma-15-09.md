...
Laure, 15/09/2026, 16:34-16:53, une prise de carte (courbe-lot-laure, 1 109 s,
après 828 s d'attente derrière Manon). Ordre : Sage
[`sage-mma-lot-15-09.md`](sage-mma-lot-15-09.md). Protocole scellé :
[`protocole-courbe-lot-mma-15-09.md`](protocole-courbe-lot-mma-15-09.md)
(laure 2e166d5). Code : main dd2f01f (v0.6.2, `_MOE_DECODE_MMA_MIN_T`
...
## En-tête de mesure (REGLES §3)
    ...
    godet        sous graphes la garde v0.6.2 lit le GODET (2/4/4/8 pour
                 b=2/3/4/6 — Laurine), pas le lot réel : b=3 et b=4 partagent
...
**Critère de Sage** (J(MMA) ≤ J(GEMV) ET ms ≤ 1,02×) : **aucun lot de 1 à 6
ne le satisfait** ; seul b=12 le satisfait. En ms, aucun lot ≤ 6 n'est
même sous 1,18×. **Réfuté** au sens de Sage (b=6 ≥ 1,02×) : « la glue
n'est pas le seul coût fixe, le seuil attend route+pack ».

**Prédictions de Sage** (ms +20/30, +5/15, −3/+5, −8/−14) : tenue à b=2
...
prendre la MMA qu'aux godets ≥ 12), à Laurine. Rien ici ne touche le
certifié b=12 (c6377d5).

## Trois états

    critère Sage (b ≤ 6)   RÉFUTÉ à tout lot (ms 1,18-1,56×)
