# Verdict — bras A (calibration anglaise ≥16k jetons) : conversion faite, NOMINAL, PPL à Laure

Manon, 17/09. Ordre Sage (`sage-hadamard-verdict-17-09.md` § 3) : Hadamard
...
comparatif de Laure) : `outils/carte.sh` non utilisé pour cette étape.
...
corpus change ce que l'AWQ voit, cohérent avec l'hypothèse de Sage.

## Contrôle demandé par Sage : la ligne « calibration sur … jetons »
