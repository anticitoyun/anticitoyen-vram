# Verdict — Nemotron-3.5-Lightning-30B-A3B, convertis calibA corrigés (poste2 315decc) : A `-etendue4096-repli8` **1,0950**, B `-sansdown` **1,0273** → aucun ≤ 1,020, chantier qualité Nemotron FERMÉ pour de bon, menus = precision-officielle 1,0304
...
scellé (poste7) : seuil unique ≤ 1,020 classé, le plus bas gagne ; prédictions A 1,015-1,030, B 1,020-1,030 ; aucun ⇒ fermé, menus = officiel 1,0304
