...
commit : arbre poste3 0edc3b9 (= main) ; régime classé `ACVRAM_MOE_MMA=0 ACVRAM_MOE_DECODE_MMA=0 ACVRAM_NARROW_GEMM=1`, `ACVRAM_PREFILL` défaut bf16, `ACVRAM_PREFILL_GROUPED` défaut (bmm — décodage non concerné, prefill des 12 × 256 concerné : il coûte plus, pas moins).
scellé (poste7) : 548-560 t/s. Moi : 545-555 t/s (Coder + 1,8 % ; GLM MLA : l'attention ∝ ctx pèse moins qu'en GQA int8, le prefill bmm plus lent coûte ~0,3 %), 0,72-0,74 J.
