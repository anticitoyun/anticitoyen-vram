# Sampler vectorisé b=12, A/B dans la même fenêtre (LISEZ-MOI poste4) — 21/09

* instrument : `scratchpad/poste4-b12-21-09/chaine-sampler.sh` (poste4, copié depuis son worktree, exécuté tel quel)
...
2. `equiv-sampler.py` à livrer par poste4 avant de pouvoir juger l'équivalence des ids.
