# P3 (3) Qwen3-VL-30B après correctif collect.py — RÉFUTÉ, mais net progrès — 21-22/09 (Manon)

* instrument : `scratchpad/mm-qvl-20-09/chaine-p3-3.sh` (worktree manon-w-21-09), référence `ref-30b-bf16.pt` réutilisée
...
## Suite
Qualité encore hors seuil : le résidu de 2487 experts sans stats (routage top-8/128 sur un corpus de calibration limité) reste la cause probable, pièce 25 (politique de repli) transmise à Océane. Pointeur transmis à la Maîtresse. J'enchaîne sur le trou de Laure (TRT-LLM) puis la frontière.
