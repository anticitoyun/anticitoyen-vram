# Pièce 90 — `graphes=on` ment quand des clés sont refusées (poste3, 23/09)
...
## Cause (reste (c) de la pièce 88, poste1)
...
Le verrou était tenu par poste2 (p89-b12-abba, mesure ABBA) au moment de jouer les tests ; ils
