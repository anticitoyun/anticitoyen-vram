# Océane — équivalence pile/boucle GLM alpha-commun (16/09), RÉFUTÉ
...
Critère `sage-glm-equivalence §2` (`verdict_position`, 5 ulp).
...
l'investigation ; carte rendue à Laurine.

**Conséquence sur l'ordre de Sage (§2)** : ce n'est PAS le cas
