# Verdict — contrôle GUI `energie.j_par_jeton` (/metrics, chef 4b83a2f) contre `energie.py` sur la même fenêtre : **0,3794 contre 0,3801 J/jeton, écart −0,18 %** → **TENU** (± 10 %)
...
commit : ce03a74 (poste3 = main 4b83a2f), 06:57, régime classé, rpw=4 défaut, graphes on
...
scellé (poste7) : |GUI / energie.py − 1| ≤ 0,10 ; prédiction < 3 %
