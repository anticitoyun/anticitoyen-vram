# Pièce 96 — tuile BN 16 et 4 warps aux petits godets : FAUX (plus lente partout) ; à côté, 4 warps seuls, au bit, −0,7 à −1,5 µs — 23/09 (Océane)
...
* **scellé** : `scratchpad/oceane-p96-23-09/scelle.md`, commité et poussé avant la prise. Variante principale : bn16w4 à C servi.
...
* **ce que cela ordonne (au chef)** : fermer la 96. En pièce neuve, à sceller avant toute prise : `WARPS_COMPACT` = 4 pour les godets B ≤ 4, 8 au-delà.
  ...
  * La cellule servie b=1 en ABAB reviendrait à Manon (prédit −1 à −2 % du pas).
