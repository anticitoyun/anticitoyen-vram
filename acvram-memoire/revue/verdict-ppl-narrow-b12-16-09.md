...
Manon, 16/09. Ordre Sage (`sage-narrow-b12-16-09.md`), amendant le voyant
...
## (1) PPL teacher-forcing — seuil scellé (Jérôme) 1,000 ± 0,002
...
rejeu) coûte 0,29 % de PPL supplémentaire par rapport à eager — à Laurine.
...
demandée par Sage ; sous graphes le compte ne peut être qu'un indicateur
...
**Règle le s3@3 de Laure** (`verdict-narrow-voyants-15-09.md` § (2)) : sur
...
PPL de production, de peu. Rendu à Jérôme/Sage — décision narrow ON/OFF en
