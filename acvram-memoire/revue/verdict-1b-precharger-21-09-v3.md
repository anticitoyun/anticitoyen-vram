...
* commit : 8a92ffbc, worktree `manon-8a92ffbc-21-09`, `.venv` reconstruit par `install.sh` (cuda-toolkit[nvcc,cccl] installé — corrige le `nv/target` manquant de la v2)
