...
## Reste
Colonne llama.cpp close (Coder classé, GLM non). TabbyAPI (EXL3) : convertis à vérifier / conversion de Manon ; vLLM remesuré une fois sur le ModelOpt sain de Manon (Coder) — ordre de Sage.
