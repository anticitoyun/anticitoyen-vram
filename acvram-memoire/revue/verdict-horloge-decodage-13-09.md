...
Laure. Campagne exécutée en service systemd détaché (`horloge-laure.service`,
2 min 9 s de mur, 5,4 Gio pic) après quatre échecs du superviseur de session
(tue sur MemFree brut — cf. `outils/carte.sh:76-84`, diagnostic de Jérôme).
...
ci-dessous). Le sens de la thèse de Sage (l'horloge, pas le plafond,
...
Si Jérôme souhaite assouplir la contrainte de perte (le protocole ne l'exclut
...
produit renvoyée à Jérôme.

## Décision — 13/09/2026

**Non retenu.** L'utilisateur, par Jérôme : aucun réglage d'horloge —
