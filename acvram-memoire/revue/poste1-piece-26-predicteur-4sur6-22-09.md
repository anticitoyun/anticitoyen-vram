# Pièce 26 — prédicteur « Four Over Six » hors ligne : G est positif par construction, la classe gagnante est l inverse de ce qu on dit, et le prédicteur MSE ne prédit pas la qualité (22/09, poste1, à sec)
...
**Les modèles extérieurs qui annoncent « amax/4 gagne sur les queues lourdes » ont le signe à l envers** ; c est la contradiction que la chef demandait de trancher. `platitude_gagnants` / `platitude_perdants` publient la mesure par tenseur.
