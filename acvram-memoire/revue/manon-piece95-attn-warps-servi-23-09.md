# Pièce 95 — attention 4 vs 8 warps, servi ABAB, ≥5 lots/bras, seuil 2σ (Manon, 23/09, ordre Jérôme)

instrument : `scratchpad/manon-piece95-attn-warps-23-09/bloc.sh <b> <ctxmax> <jetons>`, ABAB
...
commit : d79f08d5 (main, worktree manon-w-21-09)
...
verdict : confirme le désaccord banc/servi déjà noté par Océane (pièce 92) — **b=12 servi : 8 warps
  ...
  passant le seuil 2σ. Décision réservée à Manon par la pièce 92 : **je ne bascule pas le défaut**
...
suite : ma file — (b) rejeu vLLM b=12 de la pièce 89 aux nouveaux défauts (réduction déroulée +
  4 warps inchangé) ; Jérôme : écart d'attention restant contre vLLM sans objet à b=12 tant que 8
