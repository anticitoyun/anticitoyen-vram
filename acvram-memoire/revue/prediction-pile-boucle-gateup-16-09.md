...
Océane, 16/09/2026, avant mesure (Sage, sage-glm-gateup-16-09.md §2.1).
...
`test_pile_egale_boucle_a_un_ulp`). Critère `sage-glm-equivalence §2`
...
détail : revue/oceane-equivalence-pile-gateup-16-09.md.
