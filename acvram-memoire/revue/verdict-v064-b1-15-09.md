...
Laure, 15/09/2026, 18:09-18:14, une prise de carte (v064-laure). Ordre :
Jérôme, seuil **4,30 ± 0,02 ms / 232,7 t/s** (le good c652947 de la
bissection, [`verdict-gemvmax-bissect-15-09.md`](verdict-gemvmax-bissect-15-09.md)).
Moteur : main f2273d7 (v0.6.4 = da17b01 d'Océane, fp32 seulement sigmoid + biais, + une note de revue), relevé au journal de l'unité.
