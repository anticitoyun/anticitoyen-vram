# Pièce 87 bis — σ intra-serveur, ABBA L/N à b=12 (Manon, 23/09)
...
instrument : `scratchpad/banc-llamacpp-16-09.py` decode, `BANC_SLOTS` avec répétitions de 12 (5 par
  ...
  les 2 s ; `scratchpad/manon-p87bis-23-09/prise.sh` — écrit uniquement dans son propre dossier
commit : 7cbd8aa5
...
scellé : ABBA L1,N1,N2,L2 (2 occurrences par bras, serveur redémarré à chaque occurrence, L après
  ...
  entre moyennes L et N ; σ (échantillon) publié par bras (`scratchpad/manon-p87bis-23-09/scelle.md`,
  avant la prise)
...
verdict : critère TENU cette fois — écart des moyennes L vs N = −1,34 %, dans la bande ±3 %. σ mesuré
  (4,01 % / 3,06 %, CV 3-4 %) confirme l'ordre de grandeur donné par Océane (4,5 %) : le −6,72 % de la
