...
poste2, 13/09/2026. Bead `anticitoyen-vram-brd` étape 1 (poste4, MMA FP4
...
**Seuil de décision (posé par chef, repris ici avant mesure)** : un
...
directe avec la littérature citée dans `revue/duck-poste2-12-09.md`
...
`python outils/fake-quant-a4-llama2-7b.py --pour-de-vrai`, quand poste1
rend la carte (~1 h de PPL par régime, donc ~3 h pour les trois — à
confirmer avec chef si un sous-ensemble suffit, par exemple sauter le
