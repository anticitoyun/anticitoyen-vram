...
poste3, 16/09/2026, avant mesure. Ordre : chef / poste4 (dcb09ba) : sans `ACVRAM_HYBRID_SLOTS ≥ b`, 8 des 12
...
`HYBRID_SLOTS=12`) mesuraient le chemin batché entier. Arbre : travail/poste3 au commit de ce protocole (`acvram/`
...
Scellé (poste7 § 9) : arbitre ≥ 80/84, cos ≥ 0,9999 ; fp8 : PPL D/C dans 1 ± 0,004.
...
Unité `slots12-poste3`, ≈ 12 min, sorties `scratchpad/arbitre-slots12-16-09/`.
