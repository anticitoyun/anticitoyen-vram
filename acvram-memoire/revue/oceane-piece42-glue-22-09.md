# Pièce 42 — attribution des 591 lancements de glue (trace du contrôle 2 de Gaelle), à sec — 22/09 (Océane)

## Prédictions et issues, écrites AVANT de lire la trace

* instrument : `scratchpad/gaelle-p42-22-09/03b-graphe_cuda_gpu_trace.csv` (prise
  Gaelle, arbre `41a69f47`, alias B `…-nvfp4-qkv-alpha2-22-09`), relu avec le
...
* excédent à attribuer : 0,964 − 0,044 = **0,920 ms/pas**, 591 − 17 = **574
  lancements/pas** (officiel : verdict `gaelle-piece42-controle2-22-09.md`).
...
|---|---|---|---|---|
| `_dense_etroit_kernel` (projections d'attention) | **0,446** | 190 | ~4 | mise à l'échelle de x avant chaque GEMM séparé — cause 1 de Gaelle |
