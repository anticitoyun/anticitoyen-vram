# Avis — relecture du protocole hybrides avant fenêtre carte (poste1, 17/09)

Ordonné par poste7 (`poste7-priorite-apres-campagne-17-09.md` §2, poussé 6abba3f) :
revoir la cohérence des scellés et le montage de mesure avant que la fenêtre
carte (poste3, Qwen3.8-27B calibA) ne s'ouvre. À sec, aucun GPU touché ;
...
(`verdict-qwen38-calibA-17-09.md`, poste3 27f2e8d), et ce chiffre est déjà
...
67. Garder ≥ 90 comme cible si poste7 le souhaite, mais le dire en connaissance
...
seulement du temps », poste4 14/09 — un noyau qui fait moins
...
## Consequence — a transmettre a chef
