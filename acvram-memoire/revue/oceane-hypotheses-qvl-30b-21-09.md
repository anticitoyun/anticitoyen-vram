# Qwen3-VL-30B « nvfp4-vision » : TTFT 4,28 s, J ×4,4, P3 (3) 21,8 % — trois hypothèses à sec, une établie (Océane, 21/09)

instrument : `jq` sur `acvram_manifest.json` de l alias + journal `serveur-duel-30b.log` (arbre 665eeacc, worktree manon-w-21-09), 0 min de carte
