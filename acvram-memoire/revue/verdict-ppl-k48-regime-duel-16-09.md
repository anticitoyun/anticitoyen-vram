...
- **instrument** : `scratchpad/reppl-eval-16-09.py` (ligne de Manon, wiki-gptq 2048/2048, min-context 256, 4 fenêtres, régime lu), `ACVRAM_MOE_MMA=0`, `ACVRAM_QA_COMPTE=1` ; sorties `scratchpad/ppl-k48-w4a16-16-09/`
- **commit** : travail/laure **d6c7b27** (code `acvram/` = main ce71723, noyau par ligne inclus) ; protocole même commit
...
- **scellé** (Sage § 8.2) : ≤ 1,005 ; réfuté > 1,010 → `-avant-noawq-experts`. Moi : 1,000-1,004
- **mesuré** : **8,156925 / 8,1427 = 1,00175**
- **verdict** : **TENU** — `GLM-4.7-Flash-srcbf16-nvfp4-k48` est le converti du duel, régime « prefill W4A16, décodage MMA=1 MIN_T=5 » ; ma prédiction tenue (le retrait des 124 tables int8 coûte +0,004 sur le 0,998 du livrable, dans l'attendu ≤ 10 % d'Océane)
