...
poste2, bead `anticitoyen-vram-brd` étape 1, suite du verdict A4 nu
(PPL 5,7550, +2,58 %, seuil dépassé). Mesuré sur la 5090, carte prêtée par
chef, `python outils/smoothquant-a4-sweep.py --pour-de-vrai`. Prédiction
...
* **A8 nu (E4M3, +0,13 %) reste le meilleur résultat GLOBAL** parmi tous
  ...
  uniformément — mais poste4 a établi (13/09, ptxas 13.4 sm_120a) que
...
- Chiffrer le débit d'un régime mixte (down_proj en A8 ou A16, les 6
  autres en A4/mxf4nvf4) une fois le noyau MMA de poste4 disponible pour
