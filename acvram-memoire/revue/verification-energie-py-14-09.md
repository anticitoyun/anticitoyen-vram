# Vérification `energie.py` (point 2, duck.ai chef 14/09) — à sec

poste3, en attendant la carte pour A8. Question posée : `outils/gpu/mesure/energie.py`
...
défaut**, sous le seuil de 30 s que chef demande. Pire : mes propres
