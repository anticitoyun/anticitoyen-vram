...
poste1, avant mesure (poste7, poste7-glm-w4a4-16-09.md).

Même script/critère que poste1-equivalence-pile-gateup-16-09.md, sur
...
**Seuil (poste7)** : delta(alpha-commun) ≤ 1,2 × plancher → pas de bogue,
...
confirme la lecture de poste4 (garde de lot `model.py:1340`, pas
l'échelle).
