...
44 %.** Le chiffre de chef (« peut coûter 31 % ») était une borne basse —
...
## Défaut du serveur — la question posée par chef
...
de chef : le réglage par défaut est correct au décodage à faible
...
service — sujet à trancher par chef (créer le bead de correctif si retenu ;
