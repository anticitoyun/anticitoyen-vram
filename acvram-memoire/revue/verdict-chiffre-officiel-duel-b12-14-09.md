...
pour octet entre `travail/laure` et `anticitoyen-vram`, vérifié par
...
(main), PAS `travail/laure`** — vérifié par `acvram.__file__` dans le
journal.
...
des créneaux fantômes d'Océane, +11 % annoncé et cohérent en ordre de
grandeur ; MoE MMA par défaut de Manon ; autre) explique ce gain — hors du
