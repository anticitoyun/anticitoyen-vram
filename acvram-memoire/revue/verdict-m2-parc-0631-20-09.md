...
suite : poste7 : catalogue marqué 0.6.31 ; poste1 : i8c petit pool 7,3 Gio (mesure sous lot 12 × 1 024 avant de conclure) ; chef : indexer, fusionner l'instrument ; ma file : M3 2a-bis (6661bb96) dès « trou fini » → M4 pièce 3 (6643f243)

## Rejouable
`cd <worktree poste2> && POSTE=20-09-1030 ACVRAM_CPUS=0-15 ACVRAM_ARBRE=$PWD bash scratchpad/m2-parc-20-09/chaine.sh` (13 min avec l'extension du .deb en cache ; sorties `scratchpad/m2-parc-20-09/<alias>.json`).
