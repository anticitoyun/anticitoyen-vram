...
poste1, 15/09/2026, avant implémentation (pas une mesure GPU — je
recâble une fonction pure à partir de chiffres déjà mesurés par poste3,
revue/verdict-narrow-voyants-15-09.md).

## Rappel de la règle (poste7 §7.2, poste7-reprise-15-09-b.md)
...
Avec les chiffres réels de poste3 (narrow A/B = B/A sous test, témoin =
...
à la règle de poste7 — à corriger avant tout usage.
