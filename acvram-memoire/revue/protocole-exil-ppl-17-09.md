# Protocole — l'exil change-t-il la sortie ? (poste7, poste7-exil-ppl-89-priorite-17-09 ; règle 9 : une voie qui change la sortie est un bogue moteur)

objet : `models_acvram/Qwen3-4B-srcgguf-nvfp4` (36 couches, 3,2 Go : 30 s par point), tranche 0 de `corpus-prive/tranches-glm`, `ppl-acvram-17-09.py`, régime classé, arbre poste3 27f2e8d (main ≥ 7ca777d).
...
scellé (poste7) : voie juste ⇒ E1..E4 = R ± 0,002 (géo de la tranche). Prédiction : E1 ≠ R et E2 = R (course flux/événements layers.py:388-399). Si E1 = R : le défaut est propre au 70B ou à la taille → seule une fenêtre 70B POOL_SYNC + PPL (~25 min) est alors autorisée.
