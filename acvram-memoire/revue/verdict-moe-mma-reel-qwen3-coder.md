...
poste2, 13/09/2026. Suite de `revue/prediction-moe-experts-a4.md` (addendum
...
(échappe au garde-fou MemFree du superviseur — cf. poste4/chef). Corpus
...
poste4 (8600/10500 j/s) : chargement froid dans ce script, pas un régime
...
Piste « lissage homogène par bloc » (notée par chef comme repli si la
