# Revue de Manon — protocole du témoin MoE
...
refusé si la première ligne ne paraît pas. C'est la question posée à Laurine,
...
## 4. `nbytes` : la correction d'Océane est juste pour la mémoire, fausse pour les poids
...
`self.plat.numel()` la donne exactement. Océane a raison sur ce point.
