# Sage — C1 noyau faux d'un facteur 42 (1 148 ms contre 27,2) : C1 se ferme sur le poste prefill comme écrit d'avance ; le prefill Coder reste Marlin W4A16 et son chantier devient C15-prefill (norm + glue, −15 ms, ≥ 20 500 j/s), sans risque de qualité (20/09, 00 h 03, heure du commit)

Source : `verdict-c1-noyau-19-09` (Manon 5d55967a) ; `sage-c1-route-i-c17-19-09` addendum 23 h 10 (« à écriture pleine le trafic seul vaut 27 ms ; écriture ≈ 1,0 × → C1 se ferme sur le poste prefill, dit d'avance ») ; `verdict-budget-prefill-19-09` (P2 i8c 96,8 ms : experts 49,5, projections 12,0, flash 12,7, glue 8,2, norm 9,1) ; `sage-concurrents-2700-verite-b12-20-09` (prefill 17 784 contre vLLM 20 824).
