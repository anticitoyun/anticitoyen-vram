...
Laure, 15/09/2026, 20:28-20:31 (unité nsys-rejeu-laure, carte vide 34 °C).
Ordre : Sage § 5 [`sage-reprise-15-09-b.md`](sage-reprise-15-09-b.md).
Protocole scellé : [`protocole-nsys-trous-rejeu-15-09.md`](protocole-nsys-trous-rejeu-15-09.md)
(laure 5539846). Moteur : main 77b5def (v0.6.5 ; `[PREUVE] MMA=True MIN_T=9
...
Sage : trous ≥ 1,5 ms → PDL ; < 0,8 ms → fusion normes/routage/quant.
...
C'est le poste que `narrow_gemm` (Laurine 5802e1b, 12,04 → 9,52 ms)
