# Levier 2 (1) : ids/logprobs au bit b=1/b=12 sous ACVRAM_RAPATRIEMENT_EPINGLE=1 — TENU — 22/09 (Manon)

* instrument : `outils/carte.sh pytest tests/test_pipeline_decodage.py -q` (worktree manon-w-21-09, main d7e57da2+)
