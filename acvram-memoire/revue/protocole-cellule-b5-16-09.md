...
[`poste7-ordre-16-09.md`](poste7-ordre-16-09.md), transmis par chef. Arbre :
travail/poste3 figé à **b6e8d3a** (= main, v0.6.5 ; MIN_T défaut 9,
`model.py:1444` ; route+pack ; narrow selon le défaut de l'arbre au
lancement, relu au JSON). Carte après poste2 (PPL narrow).
