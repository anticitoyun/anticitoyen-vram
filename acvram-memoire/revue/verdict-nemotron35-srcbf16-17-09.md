...
Manon, 17/09. Prérequis de `sage-priorite-apres-campagne-17-09.md` §1/§2 :
...
— environnement de Laurine, hors de mon périmètre, signalé mais pas corrigé
par moi.

## Conversion réelle

Carte : dry-run 412,4 s, conversion réelle 422,4 s (intercalée dans la chaîne
FLA de Laure, verrou pris/rendu proprement, sa suite a repris derrière moi
sans intervention).
...
Prêt pour Laure : PPL 3 tranches dans la même fenêtre que Qwen3.8, corpus
bras A (comme `sage-priorite-apres-campagne-17-09.md` §1/§2 le demande).
