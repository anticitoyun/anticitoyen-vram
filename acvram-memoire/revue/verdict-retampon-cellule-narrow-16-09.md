...
- **commit** : travail/poste3 figé **c0a8b36** (code `acvram/` = main b06e337), une prise de carte 07:24-07:35
...
- **scellé** : (1) poste7 § 1 : A ≈ 14,0 ms / 0,51 J ; moi : A ∈ [13,7 ; 14,4] sinon bissection avant publication. (2) poste7 § 3 : moyenne B/A ∈ 1,000 ± 0,002 ET par tranche |B/A − 1| ≤ 1,5 × |A-g/A-e − 1| ; réfuté si moyenne > 1,002 ou tranche > 1,004
...
- **verdict** : (1) re-tampon OFF = **13,60 ms / 0,494 J / 806 t/s** (ON : 11,38 / 0,412 / 962) — mon intervalle réfuté, cause en § 1 ; (2) aucune condition de réfutation atteinte, condition « tenu » fausse sur 3/3 tranches → **INDÉTERMINÉ**, poste7 arbitre (§ 2)
...
```
- Tranche 0 = poste2 à 10⁻⁶ sur les trois bras : **déterminisme prouvé**, elle compte (chef).
