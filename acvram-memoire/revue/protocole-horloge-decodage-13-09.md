...
Laure, 13/09/2026, à sec (lecture seule + calcul, sans carte). Suite à Sage,
[`sage-veille-internet-13-09.md`](sage-veille-internet-13-09.md) §1 :
...
absorbé par la perte de débit), la thèse de Sage ne se transporte pas de
...
## 3. Protocole
    ...
    prefill    UNE mesure, horloge par défaut SEULEMENT (pas de balayage —
               décision de Jérôme : le prefill n'est pas la question posée
...
Jérôme), le geste devient un réglage `ACVRAM_HORLOGE_DECODAGE` — sinon il
