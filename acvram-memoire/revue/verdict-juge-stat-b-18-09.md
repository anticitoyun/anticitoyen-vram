# Verdict — juge statistique de (b) contre le témoin graphes/eager (8 fenêtres × 3 bras) : **(i) tenu, (ii) tenu, (iii) FAUX sur une fenêtre (tr0-p256 : Δ_b = +0,043)** → pas de défaut ce soir ; « (iii) seul : on note et on cherche le préfixe » (poste7) ; Δ_b n'a pas de signe constant (3 +, 5 −), moy −0,0086
...
scellé (poste7) : (i) |moy Δ_b| ≤ 2·sd/√8 ; (ii) |moy Δ_b| ≤ |moy Δ_témoin| ; (iii) aucune fenêtre Δ_b > 0,020 ; les trois → défaut des deux régimes ; (i) ou (ii) faux → alignement bit-exact ; (iii) seul → noter, chercher le préfixe ; prédiction poste7 : tenu, moy Δ_b ± 0,004, |moy Δ_témoin| 0,010-0,015
