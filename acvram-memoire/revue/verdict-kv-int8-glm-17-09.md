...
instrument : lecture du code et des manifestes, à sec (aucune prise) · commit : arbre poste3 cbea64e (= main) · régime : GLM `-k48`, PPL prefill (`acvram eval`) — c'est là que l'inversion a été mesurée (`verdict-ppl-refonte-17-09` : privé 1,0289, public 0,9972)
scellé (chef/poste7) : PPL privée avec KV bf16, |privé − public| ≤ 0,01
