...
poste2, 17/09. Suite de `verdict-qwen38-reconversion-17-09.md` (--no-awq,
PPL 1,0306) et `d23f78b` (diagnostic + implémentation GDN/attn_output_gate,
à sec). poste7 : une itération, carte 1h20-1h30 au bord d'un bloc palier 1.
...
## Prochaine étape — poste3

Carte rendue à poste3 (Llama-70B derrière), pour la PPL privée bras-A,
même montage que `verdict-qwen38-v2-mesure-17-09.md` (f24d11e, tranches
`scratchpad/palier2-qwen38-17-09/`).

Scellé poste7, une itération, sur cette mesure :
