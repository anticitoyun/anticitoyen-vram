...
- **commit** : arbre mesuré **travail/laure-qa2 @ 89bb888** (laurine : mla_decode_1p, mla_prep_batch, latent fp8 OFF) ; trois bras d'env sur le même arbre : **A** = UNE_PASSE=0 PREP=0 (témoin 3f69c82), **B** = PREP seul, **C** = défaut (tout) ; scripts laure e80a8ea ; le bras D (fp8) attend 3a1d2fd (unité `mla4-laure` en cours)
...
- **scellé** : Laurine : lancements ≈ 1 850 ; B 19,5-20,5 ms ; C 15-17 ms ; ≤ 1 ulp. Moi : 1 800-2 000 ; B 19,0-20,5 ; C 16,0-17,5 ; `torch.equal` faux ≤ 1 ulp ; PPL C/A 1,000 ± 0,001
