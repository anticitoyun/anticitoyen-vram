# Pourquoi `Qwen3-Coder-30B-A3B-nvfp4-qkv-22-09` charge en `experts_layout=naturel` : les échelles AWQ de gate et up diffèrent, `experts_repli` n y est pour rien (22/09, Océane, à sec)

Symptôme (Manon 61708420, ccb39f2c, `verdict-familles-qkv-nvfp4-22-09`) : nouvel alias, manifeste experts nvfp4 identique à l officiel, mais 144 lancements experts, chemin `mma-a4` atteint, pas 8,62 ms contre 6,7.
