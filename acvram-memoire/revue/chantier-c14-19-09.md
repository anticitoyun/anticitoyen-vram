# Chantier C14 — grille de `mla_1p_kernel` au décodage b=1 (19/09, à sec, branche `poste1-c14-mla-1p-grille`)

Source : `poste7-glm-decode-budget-c14-c15-19-09` § 2 ; budget `verdict-budget-decode-glm-19-09` (poste2, nsys). Aucun GPU ce soir : le .cu est modifié, non compilé.
...
## Prédiction scellée (poste7, recopiée)
