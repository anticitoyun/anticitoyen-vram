...
poste2, 15/09, avant mesure (carte après P1 de poste4, ~2 h). Suite de
...
## Octets/jeton prédits (mêmes données que la note de poste4, q+o et
...
(borne 550 Go/s, même règle que la note de poste4).
...
chef, « c'est v/o »). Je la trouve moins probable a priori, mais je
...
2. Sur carte (après poste4 P1, signal chef) : les deux conversions,
