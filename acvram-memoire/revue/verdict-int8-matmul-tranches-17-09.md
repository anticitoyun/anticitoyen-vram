# Correctif — repli GEMM d'`int8_matmul` par tranches : la tête de Gemma-4-31B déquantifiée d'un coup (5,25 Gio) tombait en OOM au premier préfill (Laure 0cf7fe6)
...
échouait, après un chargement juste (exil 10/60, prédiction Sage tenue).
