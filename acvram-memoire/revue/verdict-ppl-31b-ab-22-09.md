# PPL relative A/B 31B (`acvram eval`, wiki-gptq) — ÉCHEC, exil VRAM même seul, PPL non exploitable — 22/09 (Manon)

* instrument : `acvram eval <alias> --corpus wiki-gptq.txt --window 2048 --stride 2048 --min-context 256 --json` sous `carte.sh`, worktree manon-w-21-09
* commit : main à jour
* régime : essai 1 = A (max6) et B (4sur6) passés ensemble en arguments positionnels ; essai 2 = A seul
* scellé (Maîtresse) : PPL_B ≤ PPL_A si Four Over Six vaut quelque chose
