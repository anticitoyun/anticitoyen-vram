...
commit : arbre poste3 537ea38 (bancs) ; binaire llama.cpp 4c9233c (CUDA 13.4, sm_120a, 15/09) ; protocole `protocole-llamacpp-coder-16-09.md` (4bb25e5)
...
- Le 14/09 (binaire de poste8, lots de 2 000) donnait 747,8 t/s / 0,4436 J : −5 % / +18 % ici — lots plus courts (prefill 20 % du lot) et binaire différent, pas départagés.
