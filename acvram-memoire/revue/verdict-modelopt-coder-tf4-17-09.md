...
Manon, 17/09. Décision Sage (`sage-modelopt-coder-export-17-09.md`) :
...
+ **`mto.save()` avant l'export** (Sage : ne pas reperdre une heure de
...
modèle réel est allée à la carte, après confirmation directe de Laure
...
Conforme à la décision de Sage : je ne tente ni un troisième venv, ni un
