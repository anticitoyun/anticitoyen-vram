...
* scellé (poste5.md a7885517, avant) : famille dominante prédite = projections qkv/o (+ 0,5 à + 0,8), MoE ≈ 0 ± 0,3 ; réfuté si la dominante est le MoE (vLLM ≥ 0,5 ms plus rapide sur les experts) ou le hors-noyaux
