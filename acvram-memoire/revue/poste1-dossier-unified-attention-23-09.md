# Dossier : porter `kernel_unified_attention` de vLLM 0.29 (23/09, poste1)

Dossier préparé à sec : 0 min de carte, rien de codé. Il ne sert que si la cellule (b) de poste2 laisse un écart d'attention au-delà de 2 σ.
...
1. **P·V en fp16, pas dans le dtype de V.** À :581, leur `.to(V.dtype)` passe P en bf16. Chez nous, bf16 mettait 264 sorties sur 384 hors de 2⁻⁸ (poste3, `attn_paginee.py:81-83`). On garde notre cast fp16.
...
| capture sur 7 alias, ulp, KL sur 5 invites b=1/b=12, ABBA servi (poste2) | 1,5 | 25 min en 2 prises |
