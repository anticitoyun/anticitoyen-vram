...
Océane, 15/09/2026, avant mesure. Sage §3 : le multiplicateur « 2 ulp »
...
des 16 positions, l'instrument est aveugle (Sage : « le témoin doit
...
**Conséquence directe (Sage §3, "seuil = plancher témoin + 1 ulp")** :
...
Pas encore fait (Sage demandait aussi un témoin GPU vs CPU, 5 min de
carte, après Laure dans la file) : ce second témoin pourrait confirmer
