...
poste2, 16/09. Ordre poste7 §2 (main `211faa7`), transmis par chef : le
...
**Table d'issues scellée par poste7 AVANT mesure** : alpha-commun ≤ 1,010 ET
...
/ le noyau MMA groupé, poste4) qui dégrade spécifiquement les experts
...
Rendu à chef/poste7 : bogue à investiguer côté moteur (poste4), pas côté
`convert.py`. Pas de reconversion "alpha-commun" à retenir pour un duel
avant résolution — le go de chef pour la reconversion suivante utilise de
