# Cellule b=12 officielle — vraie alternance acvram/vLLM (A/V/A/V/A/V) — TENU, 1 634,0 t/s — 22/09 (Manon)

* instrument : `scratchpad/laurine-b12-21-09/chaine-cellule-b12-vraie-vllm.sh` (harnais ea9baa0a, sidecar atomique + lecteur cassant), checkpoint `models_vllm/Qwen3-Coder-30B-A3B-Instruct-FP4-a16`, sous carte.sh (verrou interne par fenêtre)
* commit : main à jour (5d541f8a)
* régime : A1 V1 A2 V2 A3 V3, vLLM encadre chaque paire acvram, b=12, 1024 jetons/séq
* scellé (Laurine, repris de `laurine-scelle-cellule-b12-22-09.md`) : médiane acvram 1 590-1 660 t/s, réfuté < 1 596 t/s ; écart horloge par paire ≤ 3 %
...
## Suite
Carte rendue. Prochaine pièce : nsys sur trtllm-serve b=12 (`oceane-ecart-trtllm-22-09.md` § 3), puis Laure (courbe débit(b) trtllm ≤10min), puis PPL A/B 31B après correctif BOS ae519990.
