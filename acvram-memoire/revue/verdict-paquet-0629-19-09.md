...
scellé (Jérôme 07 h 14 / REGLES § 3, avant) : régime `eco=2700(...)` juste, `-rgc` à l'arrêt, pas de charge résiduelle
...
verdict : **TENU** ; charge utile non rejouée (le `.deb` 0.6.29 n'est pas dans l'arbre manon — Jérôme l'a construit sur main ; même charge utile que 0.6.27 par construction)
durée : 41 s (07:16:13-07:16:54) + prise écartée 1 min 06 s, rédaction 2 min
suite : Jérôme : feu vert confirmé ; ma file : C15-prefill d17a719d partie 1 → partie 2 → sélection par rang → main/d01eb2cb tranches-9 ; verdict β à écrire d'abord (journal `journal-beta-9tranches.log`)
