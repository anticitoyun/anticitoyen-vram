...
poste3, 15/09/2026, avant mesure. Ordre : chef, seuils de poste7
[`poste7-point0-ordre-14-09.md`](poste7-point0-ordre-14-09.md) § 4 ; PPL de D
tenue par poste2 ([`verdict-1aj-variantesDE-15-09.md`](verdict-1aj-variantesDE-15-09.md),
ratio 0,987). Attend la carte après poste2 (conversion GLM) et poste4 (3 min).
...
## Seuils (poste7) et prédictions

poste7, b=1 : **ms ≤ 3,6** (contre 4,18 ; réfuté ≥ 4,0), **J ≤ 1,10 ×**
(réfuté ≥ 1,25) ; b=12 : rendre l'écart.

Mes prédictions : les 4 projections int8 → NVFP4 retirent ≈ 0,43 Go/jeton
sur 2,30 (poste7 : attention int8 0,93 → ≈ 0,50) ; à b=1 le pas est borné par
...
(montage de poste2) — le seuil absolu 3,6 est dans un autre montage ; je
