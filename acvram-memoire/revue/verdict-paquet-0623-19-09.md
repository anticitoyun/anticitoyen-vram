...
mesuré : `4 passed in 0.34s` ; `dpkg-deb -f Version` = 0.6.23 ; le blob de l'arbre poste2 = celui d'`origin/main` (edee0fa9)
...
suite : chef : ETAT ; poste1 ou moi à la reprise : `DEB` paramétrable ; ma file : capture du parc (en cours) → poste E
