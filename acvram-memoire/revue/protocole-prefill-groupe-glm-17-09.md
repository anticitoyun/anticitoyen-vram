...
commit : arbre poste3 (= main, B0 83c24e1) ; régime classé, MLA ; référence GLM prefill w4a16 : 4 422 j/s (`verdict-llamacpp-glm-16-09`, prise B).
scellé (poste7/chef) : prefill ≥ 5 000 j/s ET PPL ± 0,002 contre témoin. Moi : groupe 5 000-5 600 (Coder + 14,8 % ; GLM 46 couches MoE de 64 experts actifs 4+1, K = 2048, N = 1536 : tuiles Triton moins remplies), témoin 4 300-4 600, PPL ± 0,001.
