# Pièce 44 — compteurs de graphes exposés, et le signe de ma table était à l'envers — 22/09 (poste1, à sec)
...
* commit : branche `poste1-compteurs-graphes` sur `9ed90223`
...
plateau. La série de poste2 est l'inverse (353,9 → 272, `b3e3fbd5`) : trois
...
## 4. Ce que poste2 relève au prochain trou (2 min, aucun code)
