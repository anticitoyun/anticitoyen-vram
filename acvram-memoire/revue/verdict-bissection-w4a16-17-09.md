...
scellé (poste7) : (i) ≤ 1,020 → nos noyaux CUDA perdent le 1 % ; (i) ≈ 1,028 → perte en amont ; (ii) témoin inerte attendu 1,028 ; (ii') MoE torch seul
...
## Ce qu'il faudrait pour finir la bissection (poste4, à sec puis 1 min de carte)
