# Pièce 87 — service à lots successifs vs serveur neuf, b=12 (Manon, 23/09)

instrument : `scratchpad/banc-llamacpp-16-09.py` decode (HTTP/SSE, BANC_URL/BANC_MOTEUR=acvram sur serveur
  déjà lancé) + `/metrics` toutes les 2 s, `scratchpad/manon-p87-23-09/prise.sh` (adapté de `oceane-p85-23-09`)
...
scellé : dernière cellule b=12 (bras L, fin de séquence 1→2→4→8→12) à ±3 % du b=12 du serveur neuf
  (bras N), même séance ; repli_eager=0 au palier 12 (scratchpad/manon-p87-23-09/scelle.md, avant la prise)
mesuré : L (lots successifs 1,2,4,8,12) b=12 : 1 756,4 t/s, 0,1406 J/jeton net, graphes_nombre=22,
  ...
  anomalie franche à b=2 cette fois — pas de conclusion, Océane instruit ce palier séparément).
...
durée : prévu ≤ 12 min / tenu 373 s (carte obtenue après 142 s d'attente, Océane p86-b2 devant)
