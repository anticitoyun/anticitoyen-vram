...
commit : arbre poste3 2f998da + sondes (ce commit)
...
scellé (poste7 § 9.2) : première perte > 20 nats à la MÊME position dans les trois → instabilité du modèle ; un seul bras → bogue de ce moteur
...
## Point 1 de poste7 (médianes, PPL par fenêtre) : en cours
