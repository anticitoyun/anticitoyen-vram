...
* instrument : `scratchpad/laurine-b12-21-09/chaine-sampler-6f-v2.sh` (nouveau, garde corrigée : 3 échantillons `ps` pendant chaque fenêtre au lieu d'un load1 qui se refermait sur son propre harnais)
* commit : d12b2a08, worktree figé `manon-d12b2a08-21-09`, arbres A/B chauds (chauffe à blanc 15s/15s)
