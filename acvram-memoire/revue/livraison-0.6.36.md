# Préparation de la livraison 0.6.36 (Laurine, 22/09, à sec)

Document de préparation, sur le modèle de `livraison-0.6.35.md` (Laure), indépendant
...
- **Serveur** (à venir, pas encore lancé) : `CompletionChoice.logprobs`
  ...
  posée pendant la mesure de Manon, en attente de carte libre. (c96d0b47)
