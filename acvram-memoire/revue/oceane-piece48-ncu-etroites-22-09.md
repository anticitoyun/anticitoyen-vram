# Pièce 48 — où part le débit à M = 12 : diagnostic ncu préparé (à sec, prédictions avant la carte) — 22/09 (Océane)
...
Gaelle. Aucun code du moteur n'est touché par cette pièce.
...
* instrument : `outils/gpu/mesure/ncu-etroites-p48.sh 7e5f6b1c`, sous
  `carte.sh` (`ACVRAM_NOM=oceane-p48-ncu`), journaux
  `scratchpad/oceane-p48-ncu/`. Quatre bras lancés, 21:55:47 → 22:00:39,
