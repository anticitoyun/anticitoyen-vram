...
poste2, 17/09. Ordre poste7 (`poste7-passage-direct-verdict-17-09.md`) : sur
les mêmes poids GadflyII/GLM-4.7-Flash-NVFP4, vLLM sert en W4A4 par
construction (`compressed_tensors.py:735-743`, lu par poste7 : `input_quant
...
Pas de mesure de ma part (à sec, pas de carte) : à poste3, servir vLLM sur
