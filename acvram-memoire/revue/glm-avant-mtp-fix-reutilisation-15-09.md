...
poste2, 15/09 soir. Question de chef (relais poste7 a6a7436) : le converti
...
utilisable avec le futur loader de poste4, ou faut-il reconvertir ?
...
poste7/chef viennent de trancher comme invariant (commit `2205709`,
ce soir).
...
une absence ambiguë, pas une identité écrite. Si le loader de poste4
distingue les deux cas (probable, puisque c'est exactement ce que poste7 a
...
(`2205709`) dès que le loader de poste4 est disponible, plutôt que de
