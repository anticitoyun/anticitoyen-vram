...
Laure, 14/09/2026. Deux tentatives de profil nsys (`protocole-verdict-etabli-995gos.md`),
...
réellement insuffisante. Options qui restent, à choisir par Jérôme, pas par
moi seule :
...
actuellement réoccupée par Manon (`manon-profil-decode`).
