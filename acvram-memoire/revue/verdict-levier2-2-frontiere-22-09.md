# Levier 2 (2) : frontiere-pas A(flux)/B(épinglé) — RÉFUTÉ sur trou_gpu, gain énorme mais ailleurs — 22/09 (Manon)

* instrument : `outils/gpu/mesure/frontiere-pas.py` (worktree manon-w-21-09, main à jour), 4 processus A0/B0/B1/A1, Coder nvfp4, b=12, 300 pas pleins
...
* scellé (Océane, `oceane-levier-2-conception-22-09`) : tenu ssi `trou_gpu` baisse à 10-30 µs (contre 173 µs mesuré au levier 1) ; réfuté si `trou_gpu` reste > 100 µs — prédit aussi `consommer` ≤ 60 µs et `attente_evt` ≈ 6 500 µs
