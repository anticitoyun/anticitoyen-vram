# Verdict — porte GEMV groupée des experts v2 (Laurine c904806) : **FAUX** — v2 9,66 ms/pas contre v1 7,88 (+23 %), identique au bit 20/20 ; in situ non ouvert
...
commit : 8a75b48 (laure = main c904806), carte sous bridage habituel
...
scellé (Sage) : v2 ≤ 5,3 ms/pas ET identique au bit → ouvre ; prédiction Laurine v1 6,5-7 ms (1,2 To/s), v2 4,6-5,3 ms (1,55-1,8 To/s)
