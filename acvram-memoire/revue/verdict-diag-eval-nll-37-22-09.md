# diag-eval-nll (pièce 37), bras eval/serve sans hf — eval≈serve, tous deux FAUX — 22/09 (Manon)
...
## Suite
Bras hf (`--source <HF_DIR bf16>`, ≤10 min de plus) nécessaire pour trancher P1/P3 définitivement — à budgéter par le groupe. Carte rendue à Laure (débit kv-fp8).
