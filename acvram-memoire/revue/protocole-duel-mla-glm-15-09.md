...
[`poste7-objectif-14-09.md`](poste7-objectif-14-09.md) (livrable 48 h), transmis
par chef ; GLM-4.7-Flash-srcbf16-nvfp4 validé par poste2 (21c121f, PPL
...
## Bras
    ...
    vLLM     /mnt/4TO_SATACMR_2022/Modeles/models_vllm/GLM-4.7-Flash-NVFP4
             ...
             poste4, processus seul), KV fp8, graphes CUDA en décodage
    apparié  même source bf16 ; PAS le même format d'attention (nvfp4/int8
             ...
             réserve principale ; le fp8 dynamique de la prédiction de poste7
...
## Ma prédiction (scellée, contraire à poste7)
...
attendu : réfuté au sens de poste7 (vLLM ≥ nous avec ≤ 1,5× octets).**
