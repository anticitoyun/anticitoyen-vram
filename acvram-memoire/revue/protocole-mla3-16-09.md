...
poste3, 16/09/2026, avant mesure. Ordre : chef. Arbre mesuré : **travail/poste3-qa2 @ 89bb888** (poste4, remplace 29ec688 avant tout lancement),
...
- Bras D (latent fp8), chef : à trancher par **PPL D/C dans 1 ± 0,004** (réfuté → bf16 gardé) et mla_* attendu −0,2 à −0,5 ms.
...
Durée ≈ 3 + 12 + 5 + 27 min, unité `mla3-poste3`, en file derrière `mla2-poste3`.
