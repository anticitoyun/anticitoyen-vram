...
Océane, à sec (aucun GPU), ordre Sage §4 (`revue/sage-glm-pile-correctif-16-09.md`,
...
Correctif bon marché disponible pour Laurine : décalage binaire fixe
...
scellé ≤ 1,010 (ordre Sage, `sage-glm-mma0-verdict` §3). Manon attend.
