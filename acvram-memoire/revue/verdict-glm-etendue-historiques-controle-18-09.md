...
Manon, 18/09. Suite du scan du parc avec la garde n°2 (étendue) : plusieurs
...
ReLU² creux (`sage-glm-etendue-historiques-18-09.md`).

## Hypothèse testée et réfutée

Sage : ces convertis datent d'avant `MIN_ECHANTILLONS_AWQ` (commit
...
Sage : les 5/14 restants (`n_samples>=8`) s'expliquent par un canal
