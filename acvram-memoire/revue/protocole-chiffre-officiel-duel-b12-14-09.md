...
poste3, 14/09/2026. Suite à chef : « le 568,6 t/s du duel vient de ton
banc-horloge (Engine direct, OK), mais il date d'avant le masquage
d'poste1 et les correctifs du jour ; le banc de poste4 sur le même moteur
donne 826 j/s au pas, poste1 717. Trois bancs, trois chiffres : il faut UN
...
(« traîne de fin de lot », l'hypothèse de chef), ce qui réduit le débit
...
## Montage
    ...
    code      `main` d'aujourd'hui (anticitoyen-vram, 3b8f173 ou plus
              récent au moment de la mesure) — PAS le worktree poste3, pour
