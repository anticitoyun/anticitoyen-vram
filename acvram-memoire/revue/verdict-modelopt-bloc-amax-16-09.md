...
poste1, à sec, ordre poste7 §6, suite à `98d1e87` (déquant/requant NVFP4
modelopt DIFFÉRENT).
...
Confirme et durcit `98d1e87` : le passage direct de poste4
(`poste7-convertisseur-formats` § 3.1) doit **copier** `weight`/
...
de ModelOpt, ce que poste7 nomme explicitement comme un chantier à part
