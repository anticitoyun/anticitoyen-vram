# Scellé — cellule b=12 officielle (Coder, graphe+épinglé) contre vLLM, 6 fenêtres intercalées (poste4, 22/09, à sec)
...
suite : poste2 joue la chaîne (protocole déjà reçu de la chef) ; à réception, verdict 7 lignes de ma part comme pour les leviers 1 et 2.
