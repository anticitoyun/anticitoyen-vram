...
* scellé (poste1/pièce 25) : haut_2se_pct prédit **6-9 %** (contre 12,6 % identite) ; réfuté si **≥ 11 %** ; alarme si < 3 %
...
## Suite
Le levier « repli médiane_couche » ne tient pas sur ce test — à poste1 : soit la statistique de repli n'explique pas l'écart de 12-13 % (autre cause dominante : plafond de la source AWQ double-quantifiée, déjà nommé dans P3(3) identite), soit n=3 images est trop peu pour trancher entre 12,6 et 13,2 (bruit sd=19,9 %). Carte gardée pour le KL acvram/bf16 (Coder, decode-pas), demandé ensuite par le groupe.
