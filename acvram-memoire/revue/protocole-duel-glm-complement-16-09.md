...
poste3, 16/09/2026, avant mesure ; complète `protocole-duel-mla-glm-15-09.md`
(9998eca) et son complément 2cb4e22. Ordre : chef / poste7 § 8 (ETAT.md 0e2fccb,
bloc 5). Arbre : travail/poste3 au commit de la prise (main fusionné juste avant,
nommé dans l'en-tête de l'unité).

## Ce qui change
- **Converti acvram : `GLM-4.7-Flash-srcbf16-nvfp4-k48`** (poste2, nvfp4 seul, AWQ
...
poste4 : **-sansawq b=12 = 55,5 ms/pas, 197 t/s, 1,55 J/jeton** (glm-gateup, A1).
...
2. **vLLM NVFP4 b=12 : 1,3-1,9 × notre débit** (270-420 t/s) — je maintiens mon
   bord contre poste7 (0,7-1,3×) ; réfuté si ≤ 1,3×. b=1 : vLLM 1,0-1,5× nous.
...
MMA W4A4 (godet 12) n'est pas la PPL de prefill ; le coût E2M1 y reste (poste7 § 8.3).
