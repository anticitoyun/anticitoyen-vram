...
Manon, 15/09 soir. Suite du signalement `calibration indisponible
('model.layers.0.self_attn.q_proj.weight')` : corrigé par Océane
(`oceane-11` 96f8434 puis 731bf4e, fusionné main `63a50cd`) —
résolution par structure (`spec.est_mla`) au lieu d'un nom de tenseur
en dur, résilience par couche.

## Mesure gratuite demandée par Jérôme : ce que vaut AWQ sur un MLA
...
## P6 (Sage/Océane) : la marge de plan de la conversion bf16 était trop fine
...
remonter à Océane, pas corrigé ce soir** : `--host-exec` ne semble agir
...
creusé plus loin (hors périmètre de ce soir, Jérôme confirme).

Contournement retenu (Jérôme) : `outils/glm-ppl-bf16-hf.py`, HF
