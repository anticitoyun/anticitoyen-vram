...
chaque tentative (vérifié) :
    ...
    tentative 1 : gpu_memory_utilization=0.85 (config du duel de Manon)
...
Manon a mesuré ce même modèle avec vLLM avec succès le 14/09
...
d'erreur lui-même) ou vérifier la config exacte du duel de Manon
