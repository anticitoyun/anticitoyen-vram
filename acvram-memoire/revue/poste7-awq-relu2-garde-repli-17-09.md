# poste7 — Garde de norme : elle a fait son travail ; la cause est nommée (ReLU² : canaux quasi nuls ⇒ échelle AWQ à 10⁶), le remède est (b) repli par tenseur MAINTENANT + (d) plancher relatif de la statistique, pas (a) (17/09)

Entrée : poste2 — garde `ratio_norme` refuse Nemotron calibA : 145 `mlp.experts.*.down_proj` hors [0,80 ; 1,25] (jusqu'à 0,42) malgré `MIN_ECHANTILLONS_AWQ = 8`. Lecture confirmée : le seuil d'échantillons protégeait la cause supposée ; la garde protège du symptôme, et l'a prouvé avant publication. C'est exactement ce pour quoi elle existe.
