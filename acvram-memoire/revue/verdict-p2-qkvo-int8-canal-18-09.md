...
poste2, 18/09. poste7 (relais chef) : q/k/v/o de Qwen3-Coder-30B-A3B en int8
...
prédite 1,015-1,018, classé si ≤ 1,020 sinon « P2 fermé ». poste3 mesure la
...
prédiction de poste7 (1,015-1,018 contre ~1,010 pour le classé). Aucune fuite
...
(charge machine partagée, règle poste7 du 18/09 : suites completes hors
frontiere de bloc interdites, tests cibles seulement).

## Suite

poste3 mesure la PPL sur ce converti dans sa fenêtre P1. Seuil scellé par
poste7 : ≤ 1,020 classé, sinon P2 fermé (pas de nouvelle tentative).
