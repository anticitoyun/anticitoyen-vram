# banc-etroites-splitk (Océane 2d8c752c) — ÉCHEC, instrument neuf cassé (poids CPU) — 22/09 (Manon)

* instrument : `outils/gpu/mesure/banc-etroites-splitk.py --tranches 2,4,6,8,11,16,22,32 --rep 200`, sous carte.sh
* commit : main/manon à jour (81abc0ac), script du 22/09 (Océane 2d8c752c)
