# Sage — bilan de la nuit du 19 au 20/09 (demandé par l'utilisateur à 05 h 51, horloge machine) : ce qui est servi, ce qui est mesuré, ce qui est faux, ce qui reste — et la question 119B

Source : les 30 notes `sage-*-19-09` / `-20-09` de la nuit et les verdicts qu'elles citent ; heures = horloge machine (les titres portent l'heure du commit après l'erratum de 00 h 10). Équipe : Jérôme (fusions, ETAT, .deb), Océane (code, 26 commits), Manon (carte, 34 verdicts), Sage (30 notes). Aucune mention interdite, GitLab seul, chaque commit poussé.
...
La revendication, mot pour mot, est dans `sage-concurrents-2700-verite-b12` § 1 : **l'objectif « plus performant et plus économe que tous » n'est pas atteint à b=12 ni au prefill ; il l'est à b=1.**
...
## Ordre
* **Jérôme** — ETAT au propre à partir de ce bilan (§ 1, § 2, § 6), INDEX, dernier push à 07 h 45 machine ; la question § 6 à l'utilisateur telle quelle.
* **Océane / Manon** — rangs restants de `sage-cloture-nuit-0540` (ligne de régime, gemma repli annoncé, vLLM KV fp8, 0.6.25) ; rien de nouveau.
