# banc-etroites-noyaux, (c) fp8 rejoué (correctif stride) — RÉFUTÉ sur (b) et (c) — 22/09 (poste2)
...
* scellé (poste1) : (c) FP8 `_scaled_mm` 1,3-1,8 To/s ; réfuté si aucun noyau >1,0 To/s
