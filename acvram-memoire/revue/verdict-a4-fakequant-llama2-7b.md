...
poste2, bead `anticitoyen-vram-brd` étape 1. Mesuré sur la 5090 (carte
prêtée par poste1, rendue à poste4 puis à moi entre les deux régimes),
...
* **W4A4 naïf ne suffit pas** : +2,58 % dépasse le seuil scellé de
  chef. Un noyau `mxf4nvf4` qui fake-quantifie bêtement les activations
...
* Le vrai gain de la MMA native (`mxf4nvf4`, ×7,9 selon poste4) reste
