...
poste2, 17/09. Suite de `verdict-palier2-llama-70b-17-09.md` (poste3) : « à
poste2 (SNR du converti) avant toute lecture ». Deux hypothèses nommées par
poste3 — la conversion `srci1_Q4_K_M → NVFP4`, ou la voie d'exil — vérifiées
...
Comparaison directe, sur le VRAI fichier de la mesure de poste3
...
sa source, sur les mêmes fenêtres. Reste l'hypothèse que poste3 nomme en
...
par poste7/chef) : instrumenter la voie d'exil elle-même — comparer,
