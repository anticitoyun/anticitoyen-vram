...
Laure, 15/09/2026, 20:32-20:46, trois prises de carte (narrow-laure,
narrow-temoin-laure, narrow-bis-laure). Ordre : Sage § 6
[`sage-reprise-15-09-b.md`](sage-reprise-15-09-b.md). Protocole scellé :
...
## En-tête (REGLES §3)
    ...
    arbres       prise 1 (narrow-laure) : arbre main 77b5def — **qui a bougé
                 sous mes processus** (fusions de Jérôme 20:31:51, 20:34:49,
                 20:35:57) ; prises 2-3 : mon worktree travail/laure figé à
...
## (2) Ties b=12 au critère d'Océane — le critère ne peut pas rendre « vrai » ici
...
pas un bogue démontré. Au sens strict de Sage (« une seule divergence hors
ex-aequo = bogue ») : une, mais le même contrôle appliqué à graphes/eager
ne dit pas mieux. **Le juge est la PPL teacher-forcing de Manon
(1,000 ± 0,002)**, comme Jérôme l'a écrit ; je rends les deux chiffres.
...
Attendu Sage ≈ 9,5 ms / 0,31 J (banc court de Laurine, décodage pur 22 s).
...
## Trois états
    ...
    (2) ties       critère INAPPLICABLE au décodage (témoin 0/768) ; narrow ≤ plancher témoin ;
                   1 divergence hors ex-aequo (s3@3, 14 ulp, sous le plancher 88) → PPL de Manon juge
    (3) b=12       11,77 ms / 0,428 J (−16 % / −16 %), Sage 9,5 non atteint en rondes (10,3 pur estimé)
