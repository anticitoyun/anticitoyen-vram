...
Laure, 15/09/2026, 16:07-16:14, une prise de carte (b1-repos-laure, 390 s,
après 2 008 s d'attente derrière `ncu-B.sh`). Ordre : Sage
...
(laure 5b0aa7b). Code : main 02a33fa (`ACVRAM_MOE_DECODE_MMA` défaut 1,
`model.py:1294`).
...
Seuils de Sage (ms −4 à −9 %, J −6 à −12 % ; réfuté si J ≥ 1,40 ou
...
groupée à 1/16 de remplissage). Conséquence scellée par Sage : **MMA=1 se
conditionne au lot** (b ≥ 4, geste `GardeSpeculation`) — à Laurine. Tant
...
(MMA=1) contre llama.cpp 1,17 (14/09, 3 moteurs) / 1,39 (chiffre de Sage),
...
Seuil de Sage ≤ 25 W à +60 s : **tenu** (15,9 W) ; ma prédiction (P8,
