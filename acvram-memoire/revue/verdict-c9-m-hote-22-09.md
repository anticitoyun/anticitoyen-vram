# C9 M-HÔTE — RÉFUTÉ, arrêt (a) confirmé — 22/09 (Manon)
...
* scellé (Océane, `oceane-c9-conception-21-09` § 3.1) : prédit 0,80 ± 0,15 ms les 4 experts (0,20 ± 0,04 ms/expert) ; arrêt (a) si > 1,2 ms les 4 (< 47 Go/s, l'hôte ne bat plus llama.cpp)
...
* verdict : **RÉFUTÉ — ARRÊT C9 (a) confirmé** — 3,417 ms très au-dessus du seuil d'arrêt 1,2 ms (×2,85), 16,6 Go/s bien sous 47 Go/s. Confirme l'alarme d'Océane du 21/09 (« noyau hôte nvfp4 scalaire, 2,2 Go/s par fil → M-HÔTE probablement > 1,2 ms → arrêt (a) ») : l'hôte ne peut pas porter le calcul d'experts pour ce chantier sans un noyau AVX-512 (plusieurs jours de travail, non engagé).
