...
Manon, 15/09 soir. Juge final scellé par Sage
(`revue/sage-glm-equivalence-15-09.md`) : PPL du converti NVFP4 ≤
PPL bf16 × 1,01.
...
| livrable | NVFP4, AWQ (correctif Océane) | **8,1275** | `acvram eval` |
...
1. Équivalence 2 couches CPU : RÉFUTÉE puis expliquée par un bogue de
   ...
   (`glm4_moe_lite` absent de trois listes) — corrigés par Océane.
