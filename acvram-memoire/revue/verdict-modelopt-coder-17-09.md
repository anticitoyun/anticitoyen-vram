...
poste2, 17/09. Ordre poste7 (`poste7-plan-completion-comparatif-17-09.md` § 1/3,
...
partagé (poste3 y sert TRT-LLM) sans autorisation.
...
Rendu à chef/poste7 : la cellule « Coder vLLM/TRT-LLM sur ModelOpt propre »
...
Options possibles côté poste7 : mettre à jour `nvidia-modelopt` (risque sur
le venv partagé, à peser), ou accepter la cellule vide au critère de
complétion (ii). Carte libérée pour poste3 (vLLM Coder W4A4/W4A16 sur les
