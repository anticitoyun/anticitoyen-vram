...
Laure, 16/09/2026, avant mesure. Ordre : Jérôme, Sage § 8 (`sage-glm-pile-correctif-16-09`,
main ce71723). Arbre : **travail/laure figé au commit de ce protocole** (code
`acvram/` = main ce71723, noyau par ligne 877169c inclus) ; extension recompilée
hors verrou (ninja, 86 s, sources identiques à laure-qa, empreinte contrôlée).

## Montage
`scratchpad/reppl-eval-16-09.py` (ligne de Manon + régime lu), **`ACVRAM_MOE_MMA=0`**
...
Converti `GLM-4.7-Flash-srcbf16-nvfp4-k48` (Manon, nvfp4 seul, 08:08).
...
les 124 tables int8 ; Océane a mesuré que ces tables valent < 10 % d'une erreur
...
0 bloc quantifié. Durée : 2 × ~7 s + chargements, unité `ppl-k48-w4a16-laure`.
