# Sage — équivalence GLM-4.7-Flash rouge (8/16 positions) : cause la plus probable, lue dans le code (14/09)

Réfutation rapportée par Jérôme : |Δlogit| 5,07 (seuil 0,05), cos 0,952 (seuil 0,999), **8 positions sur 16**, tenseurs complets, 6-pré fusionné avant (`16bac2f`), donc la détection MLA n'est plus en cause.
...
## Contrôle qui peut rendre « faux » (Océane, 10 min)
