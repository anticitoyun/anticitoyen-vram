...
A = 1 533 / 1 514 / 1 576 / 1 540 (méd 1 536) ; hier même chaîne, A graphe = 1 556 / 1 542 / 1 570 / 1 544 (méd 1 550) : −0,9 %, dans la dispersion connue (± 30-50 t/s par fenêtre). Le « 1 550 » de la chef est ce B d hier. Pas de dégradation nommable ; l écart B/A porte sur les 4 paires, A1 B1 B2 A2 A3 B3 B4 A4, sans ordre A A A B B B.

## 4. Prédiction pour la 2e passe ABBA (écrite avant)
* **B/A = 1,055 à 1,080** (service, 4 paires) ; horloge B inférieure à A de 0,5 à 2 % (carte sans repos, plafond de puissance) ; **J/jeton B ≤ 0,95 × A** (moins de temps oisif à 380 W) — si poste2 relève J.
