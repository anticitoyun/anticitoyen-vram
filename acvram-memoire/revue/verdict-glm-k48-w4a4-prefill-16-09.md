...
Manon, 16/09. Ordre Jérôme/Sage : reconversion GLM avec la métrique W4A4
...
activation_nvfp4`) donnait un ratio de **1,0183** (Sage §8) — la métrique
W4A4 rend le résultat **pire**, pas meilleur (1,0183 → 1,02292). L'hypothèse
« la métrique choisit un alpha qui élargit l'étendue intra-bloc » (sage-
...
demande à Jérôme/Sage s'il faut la mesurer quand même à titre diagnostique
avant de passer à l'option Hadamard par bloc (note séparée, déjà annoncée
comme repli par Sage).
