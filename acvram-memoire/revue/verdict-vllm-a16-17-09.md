# Verdict — vLLM forcé en Marlin W4A16 (`-a16`, Manon) : 1,016 / 1,013 × bf16 — sous notre W4A16 sur les mêmes poids (1,028 / 1,021)
...
commit : arbre laure d67596a (= main) ; config `-a16` de Manon (d574e72 : `input_activations: null`, mêmes `ignore`)
...
scellé (Sage) : 1,028 ± 0,006 sur le privé (= notre W4A16 sur les mêmes poids) → si tenu, ModelOpt propre sans objet et vitesses vLLM à remesurer dans ce régime
