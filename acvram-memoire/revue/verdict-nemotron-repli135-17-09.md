# Verdict — Nemotron-3.5-Lightning-30B-A3B `-nvfp4-calibA-repli135` (poste2, repli accepté tel quel) : PPL **1,2634 × bf16** → **non classé**, chantier qualité Nemotron FERMÉ
...
scellé (poste7) : géo ≤ 1,020 classée, sinon « non classé, précision officielle + calibA-repli135 » et chantier FERMÉ ; prédiction 1,018-1,028
...
verdict : **FAUX — 1,2634 > 1,020, prédiction 1,018-1,028 réfutée de 0,24** ; publication « non classé, précision officielle (1,0304) + calibA-repli135 (1,2634) » ; chantier qualité Nemotron FERMÉ (décision poste7)
