# Banc unified_attention aux petits lots — RÉFUTÉ au critère strict (3 cellules sur 4 ; b=1 ctx 2 048 manque de 0,15 µs) — 23/09 (Océane)
...
* **scellé** : `scratchpad/oceane-unifie-23-09/scelle-b1b2.md`, commité avant la prise. Critère : GO si (b) ≤ (c) − 1,5 µs dans les quatre cellules.
