...
commit : f38ef72 (laure = main d2670cb, Laurine a850937), 06:45-06:51, une seule fenêtre
...
scellé (Sage, sage-rpw-in-situ-gui-18-09) : seuil unique — moyenne B (ms/pas nu) ≤ 0,95 × moyenne A → tenu ; J/jeton second juge, même seuil, informatif ; ma prédiction −4 à −6 %
...
- Règle 9 remplie : équivalence au bit, mécanisme compris (activation étagée une fois par bloc de GW_WARPS×RPW lignes), gain mesuré en situ nu et en J/jeton ; le passage de `GROUPED_RPW` à 4 en défaut relève de Sage/Laurine.
- Cellule Coder b=12 à publier (Katy) après décision de défaut : nu 1 262 t/s / bridé 1 162 t/s 0,344 J/jeton (contre 1 116 / 1 034 / 0,385).
