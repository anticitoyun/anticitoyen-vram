...
commit : 7d38733 (poste3 = main 23903b5), 09:03-09:08, régime classé seul (`NARROW_GEMM=1 MOE_MMA=0 MOE_DECODE_MMA=0`, `HYBRID_SLOTS=12`), graphes on, `chemin_moe=gemv`
...
scellé (poste7, poste7-xreg-down-defaut-18-09) : moyenne des deux pas nus ≤ 9,30 ms tenu ; prédiction 9,15-9,25
...
verdict : **TENU** — 9,15 ≤ 9,30 (marge 0,15 ms), dans la prédiction ; cellule source pour poste8 : **Qwen3-Coder-30B-A3B-nvfp4 b=12 — 1 198 t/s · 0,334 J (bridé 400 W, nu 1 312 t/s, 9,15 ms/pas) · régime classé, défauts RPW=4 + XREG=down** — nu 1 312 (dérive entre fenêtres 2 %, témoins 9,51/9,72) — (remplace la cellule 35d3086 : 1 162 / 0,344 / 1 262)
