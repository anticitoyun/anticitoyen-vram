...
poste3, 15/09/2026, 18:33-18:55, une prise de carte (courbe-rp-poste3). Ordre :
poste7 § 3 (main 8dc6237). Protocole scellé :
[`protocole-courbe-lot-rp-15-09.md`](protocole-courbe-lot-rp-15-09.md)
(poste3 cca394e). Moteur : arbre main d880637 (v0.6.4 + route+pack b451ede par
...
**Critère de poste7** (J(MMA) ≤ J(GEMV) ET ms ≤ 1,02×) : **b=6 le satisfait**
(−10,5 % ms, −10,9 % J) ; b=4 non (+3,5 % ms, J bon) ; b=1-3 non (ms).
**poste7** : b=1 +10/15 (mesuré +17,3 : réfuté de peu), b=2 +3/8 (+9,1 :
...
b=4. À la lettre de poste7 (b=4 ≥ 1,02×) : MIN_T reste 9 — mais 9 laisse
...
avec une cellule b=5 (2 min) si poste7 veut le bord du godet mesuré et pas
encadré. À poste4 pour v0.6.6 si poste7 scelle.
