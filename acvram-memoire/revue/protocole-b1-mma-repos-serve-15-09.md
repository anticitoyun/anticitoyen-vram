...
[`sage-reprise-15-09-b.md`](sage-reprise-15-09-b.md) (main 02a33fa), transmis
par Jérôme. Code : main 02a33fa (défaut `ACVRAM_MOE_DECODE_MMA=1`,
`model.py:1294`).
...
Seuils de Sage : **ms −4 à −9 %, J −6 à −12 %** ; réfuté si J(B) ≥ 1,40 ou
ms(B) > 1,02 × ms(A) → MMA=1 conditionné au lot b ≥ 4 (Laurine).
...
— pas de gain, pas de perte nette ; réfuté (dans le sens de Sage) si ms
...
Seuil de Sage : **≤ 25 W** à +60 s ; réfuté si ≥ 60 W (attente active).
