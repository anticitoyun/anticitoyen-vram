# Balayage warps×étages étroites int8, sous graphe (banc-etroites-occupation) — RÉFUTÉ, au bit — 22/09 (poste2)
...
* scellé (poste1) : (8,3) ou (4,2) gagnant ; o 11,8 → ≤10,6 µs (≥10 %), qkv ≥5 % ; réfuté si <5 % sur les deux ; égalité au bit exigée
