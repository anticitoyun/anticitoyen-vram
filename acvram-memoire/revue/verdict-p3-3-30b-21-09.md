...
* instrument : `scratchpad/mm-qvl-20-09/chaine-p3-3.sh` + `references-transformers-dequant.py` (fichiers suivis, fusion 73a67474/oceane-p3-dequant)
* commit : 0133df83 (worktree manon, fusion origin/main dont oceane-p3-dequant)
* régime : jamais atteint (échec avant la partie acvram/carte)
* scellé : haut_2se_pct ≤ 3 % (Sage 20/09, `sage-ordres-restants-menus-20-09`)
...
## Suite (à Océane, auteure du script)
