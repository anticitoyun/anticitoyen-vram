# Prédiction — A4 restreint aux projections MLP/experts (recadrage de Jérôme, 13/09)
...
Manon, 13/09/2026, avant mesure. Recadrage : le noyau MMA de Laurine
(`nvfp4_gemm_grouped_mma`) ne sert QUE le chemin MoE groupé (gate/up/down
des experts) — jamais q/k/v/o. Deux mesures posées par Jérôme.
...
jumelles (le temps de carte est partagé — Laure, Laurine, Océane en
...
« moe-a4 », donc non publié comme mesure). Laurine signale mieux :
...
~8 600 sans, d'après Laurine) — sinon le chemin MMA n'est pas pris et la
