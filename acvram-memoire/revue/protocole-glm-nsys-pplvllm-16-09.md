...
poste3, 16/09/2026, avant mesure. Ordre : chef (main 3d96697, chantier MLA ouvert), 15 min, pas de ncu.
Arbre : travail/poste3 au commit de ce protocole (code `acvram/` = main ce71723).
...
Unité `glm-nsys-pplvllm-poste3`, sorties `scratchpad/glm-nsys-pplvllm-16-09/`.
