...
poste3, sur carte (`outils/carte.sh`), ~10 min. Suite à
[occupation-mla-decode-batching-slots.md](occupation-mla-decode-batching-slots.md),
avant que poste4 code `anticitoyen-vram-6wa`. `torch.profiler`, un pas de
décodage, GLM-4.7-Grande-Heretic-42B, `slots=12`, `ctx=2048`, **eager**
(`enable_cuda_graphs=False`, demandé par chef) après amorçage des 12
créneaux.
...
## Verdict contre les seuils de chef
