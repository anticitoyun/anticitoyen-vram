...
poste2, 16/09. Ordre chef, relayant le pas b=12 GLM de poste4 (main
...
manifestes, sans carte. poste7 (main `86b152b`) a nommé l'hypothèse attendue
...
aux experts). C'est le facteur dominant attendu par poste7.
...
1)`, poste7 §8, coût 0 scellé) — mais avec 390/401 réelles par échantillon,
...
à chaque jeton, sans routage — le facteur dominant nommé par poste7) et le
...
Le diff tranche seul, pas besoin du bras B∅∅ (10 min carte) que poste7
proposait en repli si le diff ne suffisait pas.

Rendu à chef/poste7 : n'entre pas dans le sort du scellé de la
reconversion (`poste7-glm-mma0-verdict-16-09.md` § 4 — noyau, pas précision,
