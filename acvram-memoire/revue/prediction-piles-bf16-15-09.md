...
Océane, 15/09/2026, avant mesure. Signalé par Jérôme relayant le journal
de Manon : régime DÉGRADÉ, `piles_ok=False`, message « formats mélangés
...
- 4 experts bf16 (`PlainTensor`) uniformes : `piles_ok` reste `False`
  (attendu, aucun noyau groupé bf16 n'existe — hypothèse 2 de Jérôme,
...
converti de Manon dira désormais directement si c'est le cas attendu
...
et pas ce qui a été demandé (Jérôme voulait la CAUSE, pas forcément une
