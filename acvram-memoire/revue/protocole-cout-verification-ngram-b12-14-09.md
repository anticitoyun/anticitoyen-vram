...
Laure, 14/09/2026. Suite à Jérôme : « (2) le coût de vérification n-gram à
...
## Montage
    ...
    modèle      Qwen3-Coder-30B-A3B-nvfp4 (régime des campagnes d'Océane/
                Manon sur le routage d'experts — même famille que le taux
                1,6137 mesuré)
    ...
    carte       exclusive, verrou `carte.sh` tenu du chargement à la fin,
                `ACVRAM_TYPE=mesure`, pas d'interlaçage (consigne Jérôme du
                14/09 relayée par Laurine)
...
## Seuil de décision
    ...
    ratio < 0,90              coût significatif : le défaut `auto` (qui
                              ...
                              SERVEUR au sens de Jérôme — proposer de le
