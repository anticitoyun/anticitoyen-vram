...
**AMENDÉ 16/09 (Sage, `sage-narrow-b12-16-09.md`) : ratio 1,000000 exact =
...
Manon, 16/09. Ordre Sage §6 (`sage-reprise-15-09-b.md`, main `77b5def`),
transmis par Jérôme, tâche confiée par Laure dans
`protocole-narrow-voyants-15-09.md` : « Manon fait la PPL teacher-forcing
...
n'en fait pas un test valide. Amendé par Sage, voir en tête de document.
