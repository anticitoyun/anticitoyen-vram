# Pièce 88 (reste a) — preuve sur carte, sortie graphes==eager, hybride GDN, godets {1,2,8,16} (Manon, 23/09)

instrument : `scratchpad/manon-p88-23-09/preuve-godets-eager.py` — deux moteurs INDÉPENDANTS (un
...
scellé : `scratchpad/manon-p88-23-09/scelle.md` — sortie graphes identique à l'eager (KL < seuil du
...
verdict : reste (a) de la pièce 88 TENU — sortie identique entre graphes et eager sur un hybride GDN
  ...
  « ligne de régime graphes=on(refus=…) » : couvertes par les tests unitaires d'Océane et par cb7c4147
  (Laure, confirmé fusionné), hors scope mesure — pas repris ici, sur accord explicite de Jerome.
