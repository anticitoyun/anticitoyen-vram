...
## Ce que ça fait à la prédiction de Jérôme sur `o_proj`
...
construire, à la demande de Jérôme.
...
Jérôme demande : si « promouvoir `down_proj` puis `lm_head` » gagne sur un modèle
