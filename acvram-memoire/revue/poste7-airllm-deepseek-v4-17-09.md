# poste7 — AirLLM et DeepSeek-V4-Flash : ce que la machine permet, chiffré avant tout téléchargement (17/09)

Entrées : `reference-airllm-17-09` (chef) ; demande utilisateur « télécharger DeepSeek V4 Flash ».
