...
[`sage-1aj-decodage-15-09.md`](sage-1aj-decodage-15-09.md) (main 0c90017),
transmis par Jérôme. Carte après Laurine puis la reconversion de Manon.
...
Scellé (Sage) : **17,92 → ≤ 16,4 ms** ; réfuté > 16,9. Ma prédiction :
...
233 de 089ec1f) ; bad = **0c90017** (main). Puis premier suspect de Sage :
...
Coupable si l'écart ABAB ≥ **0,13 ms** (Sage). Prédiction Sage : 7f3f422
