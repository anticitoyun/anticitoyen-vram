#!/usr/bin/env python3
"""Bead runner (14/09 soir) : Laurine a trouve que sa sequence "arrivee"
...
d'admission (table/position/slot_mapping). Controle de Jerome : ecart
...
def invite(k, rep=0, n=64):
    ...
    # aucune), pas forcement celle que Laurine a signalee.
