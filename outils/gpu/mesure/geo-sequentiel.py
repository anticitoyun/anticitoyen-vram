#!/usr/bin/env python3
"""Juge statistique apparié et séquentiel (sage-tests-30min-20-09 § 3.3 ; sage-reprise-rapide addendum 07 h 43) :
...
# Sage 07 h 43 (sage-reprise-rapide addendum) : à n < 5 le SE de l'échantillon est sous-estimé (β : décidé à
...
# 3.3 (sage-tests-30min-20-09) : arrêt séquentiel — décidé dès que l'intervalle à 2 SE est entièrement d'un côté
...
NMIN = int(os.environ.get("NMIN", "5"))     # Sage 07 h 43 : jamais décidé avant 5 paires (SE sous-estimé à n < 5)
