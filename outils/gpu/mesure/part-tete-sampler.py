...
# verdict 41 et Manon 63767f45 : le nom seul donnait 2,6 µs de « tête » et
...
def main() -> int:
    ...
    for d, fin in fenetres:
        ...
        # le DERNIER `cutlass…wmma` du pas, pas le premier (22/09, Manon
        ...
        # (22/09, Manon 63767f45 : le `cutlass…wmma` du ROUTEUR, 1 par couche,
