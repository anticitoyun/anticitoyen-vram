#!/bin/bash
# Banc horloge MEMOIRE x SM x energie -- Coder-30B b=12 (Jerome, duel energie
...
#
#   systemd-run --user --unit=horloge-mem-laure --collect \
#       -p WorkingDirectory="$PWD" \
#       env ACVRAM_NOM=horloge-mem-laure ACVRAM_TYPE=etat \
