#!/bin/bash
# GABARIT DE CHAÎNE À COÛT CROISSANT (sage-tests-30min-20-09 § 3.4) — sortie au premier « faux ».
...
# Racine du parc (M3, Manon 11:59) : les chaînes effacent ACVRAM_* avant de sourcer ce gabarit, et les
