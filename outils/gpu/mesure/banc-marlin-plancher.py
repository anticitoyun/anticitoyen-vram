"""Marlin de décodage à b=12 : où sont les 6 % sous le plancher ? (poste1,
22/09, `poste1-ecart-trtllm-2` § 2 levier 2 — le seul poste au bit qui reste)
...
sous plafond de puissance (poste2 : `-lgc 2700` contre libre, hors banc).
...
noyau mais dans le pas : régime d horloge/puissance, à poste2).
...
def verdict(r: dict) -> dict:
    ...
    if to_s >= PLANCHER / 1e12:
        v = "RÉFUTÉ (le noyau isolé est AU plancher : les 6 % sont dans le pas — horloge/puissance/voisinage, à poste2)"
