"""20 images 896×896 déterministes (graine fixe) pour le chantier multimodal (poste7-acvram-multimodal-20-09 § 3) :
...
poste7 peut y substituer 20 photos libres, le sha256 change et se date.  Usage : python outils/generer-images-20.py <dossier>
