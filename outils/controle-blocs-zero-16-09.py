#!/usr/bin/env python3
"""Contrôle blocs-à-zéro, GLM-4.7-Flash — ordre Sage (main 86b152b,
revue/sage-glm-pile-correctif-16-09.md), 16/09/2026.
...
Scellé (Sage) : ratio ≥ 3× ET fraction(x/s) ≥ 1 % → cause confirmée.
"""
