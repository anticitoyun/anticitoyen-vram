#!/usr/bin/env python3
"""C9-M1 (sage-c9-119b-cache-experts-19-09 § 2) : rapport de taux de succès
...
par pas (ce qui se paie en octets à b > 1), et le critère de Sage
...
print(f"  h(E/2={r['capacite_demi']}) : pin {r['h_demi']['pin']:.3f}, lru {r['h_demi']['lru']:.3f} → Δh = {r['delta_h']:+.3f} : {r['verdict_sage']}")
if a.json:
