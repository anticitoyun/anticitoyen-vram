...
Scellé neuf (sage-e-c-verdict-17-09) : distance fp64 de Triton ≤ 1,1 × celle
...
et ne juge rien. Vitesses (Sage), en REJEU DE GRAPHE (le régime servi ; l'eager, imprimé à
...
def reference64(c, tables, lens, q, scale):
    ...
    Sage (sage-e-c-verdict-17-09) — distance de chaque noyau à elle."""
    B, HQ, D = q.shape
    n_rep = HQ // HKV
