#!/usr/bin/env python3
"""Décodage vLLM à 12 séquences concurrentes, MÊME protocole que Laure
...
brut - repos×durée. Consigne de Jérôme, duel A2, 14/09/2026.
...
# comme Laure sur acvram (prefill seul avant la fenetre).
