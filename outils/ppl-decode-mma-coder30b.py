#!/usr/bin/env python3
"""PPL par le CHEMIN DE DÉCODAGE — juge de (5), Sage puis Jérôme (15/09).

Montage (teacher forcing, KV continu) différent de l'étalon 9,2056/9,1218
(fenêtres 2048/2048 réinitialisées) : le seuil absolu de Sage ne
s'applique plus tel quel. Jérôme demande DEUX bras avec CE script :
...
> 1,015 → défaut propre au décodage, retour à Laurine ; entre les deux,
retour à Sage.
...
PIÈGE VÉRIFIÉ DANS LE CODE avant d'écrire ce script (demandé par Jérôme,
...
def main() -> int:
    ...
    # Bras A (Jerome, 15/09) : =0 (GEMV W4A16, controle de coherence contre
    ...
    # Manon, 16/09 : reprend ce script pour le voyant narrow_gemm (Sage §6,
