#!/usr/bin/env python3
"""M1 (poste7, revue/poste7-cache-experts-13-09.md §5) : taux de succès d'experts,
...
(la trace synchronise — `trace_routage.py:99`, `poste7-cache-experts-13-09.md §7).
...
# Le nom porte le régime (poste7 §7) : une trace à b=1 ne prédit pas b=12.
...
def main() -> int:
    ...
    ap.add_argument("--min-jetons-total", type=int, default=50_000,
                    help="seuil bas (poste7 §5) : répète les invites si atteint pas")
