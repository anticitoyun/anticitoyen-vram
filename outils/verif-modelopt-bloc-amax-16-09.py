#!/usr/bin/env python3
"""Vérification bloc/amax — ordre Sage §6 (revue/sage-*, main 37bb20a),
...
Scellé (Sage) : ≈ 0 % → instrument désaligné (reprendre 98d1e87 avant
d'écrire) ; > 20 % → échelle de bloc réellement cherchée par ModelOpt,
le passage direct de Laurine devra inclure une recherche d'échelle dans
`quantize_nvfp4`.
