...
# (sage-gemv-experts-rpw-18-09 : scellé RPW faux ⇒ lire avant d'écrire) :
...
# Porte du dernier geste (sage-gemv-experts-dernier-geste-18-09) : gateup + down ≤ 6,2 ms/pas
...
# `sudo -n ncu` remet l'environnement à zéro (Laure, verdict-ncu-gemv-experts-rpw-
