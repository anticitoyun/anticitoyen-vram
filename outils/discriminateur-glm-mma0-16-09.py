#!/usr/bin/env python3
"""Discriminateur précision vs noyau, GLM-4.7-Flash — ordre Sage
(revue/sage-glm-mma0-verdict-16-09.md §3, main f48c0f7), 16/09/2026.
...
Scellé (Sage) : err(iv)/err(iii) ≥ 1,5 → (1b) précision, noyau innocent ;
≤ 1,1 → (1a) application, correctif Laurine. Entre les deux : témoin ulp
d'Océane (`sage-glm-w4a4` §1.2 / `revue/prediction-plancher-w4a4-16-09.md`)
...
def main() -> int:
    ...
    if ratio >= 1.5:
        ...
        verdict = "(1a) application — correctif Laurine"
    else:
        verdict = "zone grise — témoin ulp tranche (sage-glm-w4a4 §1.2)"
