...
PILES RÉELLES d'un converti (sage-p1-situ-verdict-18-09 : ppl-decode-kv
...
routages) :
  ...
  - biais_signe = moy(Δ) / moy|y|          (le critère de Sage : ≤ 1e-4) ;
...
traiter_echelles_nvfp4) — hypothèse 2 de Sage (tables ≠ E4M3), chiffrée sur
