#!/usr/bin/env python3
"""Vérification bit à bit — modelopt NVFP4 déquant/requant, ordre poste7 §doute
(revue/poste7-convertisseur-formats-16-09.md, main 1cf933b), 16/09/2026.
...
Doute de poste7 : si `quantize_nvfp4` retrouve exactement les mêmes codes
et échelles (même formule `amax/(448·6)` global, `amax/6` par bloc),
le trou 1 (§3.1) se réduit à une option `--no-awq` + garde manifeste ;
sinon poste4 écrit le passage direct (mapper les tenseurs bruts vers
