...
outils/banc_prefill_chaud.py (poste4, branche poste4, ea98f36) :
...
génération) — remarque de poste4, 14/09, duel A2.
...
# ("depuis la reinstallation" de chef). FLASH_ATTN refuse ensuite : le
