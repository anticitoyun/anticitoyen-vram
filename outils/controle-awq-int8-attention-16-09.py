#!/usr/bin/env python3
"""Contrôle AWQ int8 sur q/kv/o (attention), GLM — ordre Sage §5
(revue/sage-glm-pile-correctif-16-09.md, main f127a2e), 16/09/2026.
...
autant. Avant de les retirer pour la reconversion (recette Manon), un
...
Scellé (Sage, note originale — ATTENTION, sens du ratio, cf. verdict) :
