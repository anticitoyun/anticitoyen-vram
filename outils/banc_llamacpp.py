...
chacune, énergie NVML monotone (energie.py, protocole de poste3).
Consigne de chef, 14/09/2026 (ferme le tableau du duel à 4 moteurs).
...
def main() -> int:
    print("BEAD audit poste7 A2 — llama.cpp, meme protocole vLLM/acvram/TabbyAPI")
