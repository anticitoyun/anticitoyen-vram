"""Disposition unique Marlin servie AUSSI au décodage (sage-p1-disposition-
...
Bandes (Sage) : Marlin b=12 ≤ 5,5 ms/pas ET b=1 ≤ 1,0 → disposition unique,
...
(2 j, bit-exact) ; si (b) échoue, P1 fermé VRAM. Prédiction Sage : b=12
...
Bras (b) (sage-p1-disposition-unique-18-09, GO Sage 18/09 sur le chiffrage
revue/p1-disposition-unique-chiffrage-18-09) : `nvfp4_gemv_marlin[_gateup]`,
le GEMV lisant la disposition Marlin. Scellé (Sage) : (b) ≤ 0,97 × GEMV à
b = 12 ET à b = 1, chaque chemin contre fp32 (part hors 2⁻⁷ ≤ 5·10⁻⁴ ou ≤ celle
du GEMV) ; faux → P1 fermé VRAM, verdict daté. Prédiction Laurine (à sec,
...
# Biais (sage-p1-situ-verdict-18-09, REGLES § 4 bis : un comptage ne détecte
# pas un biais) : moyenne signée de Δ rapportée à moy|y| (critère Sage ≤ 1e-4)
...
def main():
    ...
    # (« expected scalar type Byte but found Float8_e4m3fn », Laure) : deux vues
