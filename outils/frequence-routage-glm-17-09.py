#!/usr/bin/env python3
"""Fréquence d'activation des experts GLM — résidence dynamique, ordre Sage
(revue/sage-avis-exterieur-16-09.md § point 2 ; repris le 17/09,
revue/sage-plan-completion-comparatif-17-09.md § 3), à sec.
...
Scellé (Sage, 16/09) : attendu ≥ 80 % ; réfuté si < 60 % sur 50 % des
