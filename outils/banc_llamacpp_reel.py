#!/usr/bin/env python3
"""Duel — llama.cpp, binaire REEL sm_120 (poste8), meme protocole que
...
200 jetons chacune, energie NVML monotone (energie.py, protocole de poste3).

Mesure 2c de poste7 (14/09) : la reference deja citee (x1,91) venait du
...
REFAIT la mesure avec le vrai binaire construit par poste8 depuis
...
def main() -> int:
    print("Mesure 2c poste7 — llama.cpp binaire reel sm_120 (poste8), "
