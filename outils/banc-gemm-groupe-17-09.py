#!/usr/bin/env python3
"""Porte de B1' (sage-b1-verdict-17-09) : le noyau seul, 5 min de carte.
...
(Sage, pas de 3e essai). Le juge d'équivalence tourne d'abord sur ces entrées.
...
def main():
    ...
    porte = 85.0
    print(f"porte B1' : ≥ {porte} TFLOPS sur gate/up ; sinon clos à B0 (sage-b1-verdict-17-09)")
